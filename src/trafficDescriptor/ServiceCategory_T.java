...
/**
* trafficDescriptor/ServiceCategory_T.java .
...
public class ServiceCategory_T implements org.omg.CORBA.portable.IDLEntity
{
  ...
  private static trafficDescriptor.ServiceCategory_T[] __array = new trafficDescriptor.ServiceCategory_T [__size];

  public static final int _SC_CBR = 0;
  public static final trafficDescriptor.ServiceCategory_T SC_CBR = new trafficDescriptor.ServiceCategory_T(_SC_CBR);
  public static final int _SC_VBRRT = 1;
  public static final trafficDescriptor.ServiceCategory_T SC_VBRRT = new trafficDescriptor.ServiceCategory_T(_SC_VBRRT);
  public static final int _SC_VBRNRT = 2;
  public static final trafficDescriptor.ServiceCategory_T SC_VBRNRT = new trafficDescriptor.ServiceCategory_T(_SC_VBRNRT);
  public static final int _SC_ABR = 3;
  public static final trafficDescriptor.ServiceCategory_T SC_ABR = new trafficDescriptor.ServiceCategory_T(_SC_ABR);
  public static final int _SC_UBR = 4;
  public static final trafficDescriptor.ServiceCategory_T SC_UBR = new trafficDescriptor.ServiceCategory_T(_SC_UBR);
  public static final int _SC_GFR = 5;
  public static final trafficDescriptor.ServiceCategory_T SC_GFR = new trafficDescriptor.ServiceCategory_T(_SC_GFR);
  public static final int _SC_NA = 6;
  public static final trafficDescriptor.ServiceCategory_T SC_NA = new trafficDescriptor.ServiceCategory_T(_SC_NA);
  ...
  public static trafficDescriptor.ServiceCategory_T from_int (int value)
  {
