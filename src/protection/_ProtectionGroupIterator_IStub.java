...
/**
* protection/_ProtectionGroupIterator_IStub.java .
...
/**
   ...
   * interface.</p>
   **/
public class _ProtectionGroupIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements protection.ProtectionGroupIterator_I
{
  ...
  public boolean next_n (int how_many, protection.ProtectionGroupList_THolder pgpList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                pgpList.value = protection.ProtectionGroupList_THelper.read ($in);
                return $result;
                ...
                return next_n (how_many, pgpList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
...
} // class _ProtectionGroupIterator_IStub
