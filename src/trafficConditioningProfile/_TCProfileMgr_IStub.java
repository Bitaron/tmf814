...
/**
* trafficConditioningProfile/_TCProfileMgr_IStub.java .
...
/**
   ...
   **/
public class _TCProfileMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements trafficConditioningProfile.TCProfileMgr_I
{
  ...
  public void getAllTCProfiles (int how_many, trafficConditioningProfile.TCProfileList_THolder tcProfileList, trafficConditioningProfile.TCProfileIterator_IHolder tcProfileIt) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTCProfiles", true);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                tcProfileList.value = trafficConditioningProfile.TCProfileList_THelper.read ($in);
                tcProfileIt.value = trafficConditioningProfile.TCProfileIterator_IHelper.read ($in);
                return;
                ...
                getAllTCProfiles (how_many, tcProfileList, tcProfileIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllTCProfiles
  ...
  public void getTCProfile (globaldefs.NameAndStringValue_T[] tcProfileName, trafficConditioningProfile.TCProfile_THolder tcProfile) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTCProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcProfileName);
                $in = _invoke ($out);
                tcProfile.value = trafficConditioningProfile.TCProfile_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getTCProfile (tcProfileName, tcProfile        );
            } finally {
                _releaseReply ($in);
            }
  } // getTCProfile
  ...
  public void getTCProfileAssociatedTPs (globaldefs.NameAndStringValue_T[] tcProfileName, int how_many, terminationPoint.TerminationPointList_THolder tpList, terminationPoint.TerminationPointIterator_IHolder tpIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTCProfileAssociatedTPs", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcProfileName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getTCProfileAssociatedTPs (tcProfileName, how_many, tpList, tpIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void createTCProfile (trafficConditioningProfile.TCProfileCreateData_T newTCProfileCreateData, trafficConditioningProfile.TCProfile_THolder newTCProfile) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createTCProfile", true);
                trafficConditioningProfile.TCProfileCreateData_THelper.write ($out, newTCProfileCreateData);
                $in = _invoke ($out);
                newTCProfile.value = trafficConditioningProfile.TCProfile_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                createTCProfile (newTCProfileCreateData, newTCProfile        );
            } finally {
                _releaseReply ($in);
            }
  } // createTCProfile
  ...
  public void deleteTCProfile (globaldefs.NameAndStringValue_T[] tcProfileName) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteTCProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcProfileName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void modifyTCProfile (globaldefs.NameAndStringValue_T[] tcProfileName, trafficConditioningProfile.TCProfileCreateData_T tcProfileModifyData, subnetworkConnection.TPDataList_THolder tpsToModify, trafficConditioningProfile.TCProfile_THolder modifiedTCProfile, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("modifyTCProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcProfileName);
                trafficConditioningProfile.TCProfileCreateData_THelper.write ($out, tcProfileModifyData);
                ...
                modifiedTCProfile.value = trafficConditioningProfile.TCProfile_THelper.read ($in);
                ...
                modifyTCProfile (tcProfileName, tcProfileModifyData, tpsToModify, modifiedTCProfile, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // modifyTCProfile
