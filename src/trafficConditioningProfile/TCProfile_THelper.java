...
/**
* trafficConditioningProfile/TCProfile_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from trafficConditioningProfile.idl
* Wednesday, June 15, 2016 7:24:43 PM COT
*/

abstract public class TCProfile_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/trafficConditioningProfile/TCProfile_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[6] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (trafficConditioningProfile.TCProfile_THelper.id (), "TCProfile_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    trafficConditioningProfile.TCProfile_T value = new trafficConditioningProfile.TCProfile_T ();
    ...
    value.defaultProfile = istream.read_boolean ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, trafficConditioningProfile.TCProfile_T value)
  {
    ...
    ostream.write_boolean (value.defaultProfile);
