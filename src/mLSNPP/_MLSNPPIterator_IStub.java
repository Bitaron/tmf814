...
/**
* mLSNPP/_MLSNPPIterator_IStub.java .
...
/**
   ...
   **/
public class _MLSNPPIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements mLSNPP.MLSNPPIterator_I
{
  ...
  public boolean next_n (int how_many, mLSNPP.MLSNPPList_THolder mLSNPPList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                return next_n (how_many, mLSNPPList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
