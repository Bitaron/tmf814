...
/**
   ...
   **/
public class _MLSNPPMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements mLSNPP.MLSNPPMgr_I
{
  ...
  public void getMLSNPP (globaldefs.NameAndStringValue_T[] mLSNPPName, mLSNPP.MultiLayerSNPP_THolder theMLSNPP) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMLSNPP", true);
                globaldefs.NamingAttributes_THelper.write ($out, mLSNPPName);
                $in = _invoke ($out);
                theMLSNPP.value = MultiLayerSNPP_THelper.read ($in);
                return;
                ...
                getMLSNPP (mLSNPPName, theMLSNPP        );
            } finally {
                _releaseReply ($in);
            }
  } // getMLSNPP
  ...
  /** 
     ...
     * it may raise this exception. <br>
     **/
  public void setTNANameForMLSNPP (globaldefs.NameAndStringValue_T[] mLSNPPName, mLSNPP.SNPTNAData_T[] sNPTNADataList, mLSNPP.SNPPTNAPair_T[] sNPPTNAPairList, String tNAName, String tNAGroupName, mLSNPP.MultiLayerSNPP_THolder mLSNPP) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setTNANameForMLSNPP", true);
                globaldefs.NamingAttributes_THelper.write ($out, mLSNPPName);
                SNPTNADataList_THelper.write ($out, sNPTNADataList);
                SNPPTNAPairList_THelper.write ($out, sNPPTNAPairList);
                $out.write_string (tNAName);
                $out.write_string (tNAGroupName);
                $in = _invoke ($out);
                mLSNPP.value = MultiLayerSNPP_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                setTNANameForMLSNPP (mLSNPPName, sNPTNADataList, sNPPTNAPairList, tNAName, tNAGroupName, mLSNPP        );
            } finally {
                _releaseReply ($in);
            }
  } // setTNANameForMLSNPP
