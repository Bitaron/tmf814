...
/**
* CosNotification/FilterableEventBodyHelper.java .
...
/**
    ...
    */
abstract public class FilterableEventBodyHelper
{
  private static String  _id = "IDL:omg.org/CosNotification/FilterableEventBody:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CosNotification.FilterableEventBodyHelper.id (), "FilterableEventBody", __typeCode);
    }
    return __typeCode;
  }
