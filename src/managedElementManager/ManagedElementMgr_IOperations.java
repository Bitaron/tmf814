...
/**
* managedElementManager/ManagedElementMgr_IOperations.java .
...
/**
   ...
   **/
public interface ManagedElementMgr_IOperations  extends common.Common_IOperations
{
  ...
  /**
     ...
     * <br>
     **/
  void getAllActiveAlarms (globaldefs.NameAndStringValue_T[] meName, String[] excludeProbCauseList, notifications.PerceivedSeverity_T[] excludeSeverityList, int how_many, notifications.EventList_THolder eventList, notifications.EventIterator_IHolder eventIt) throws globaldefs.ProcessingFailureException;
  ...
  /**
     ...
     * <br>
     **/
  void modifyGTP (globaldefs.NameAndStringValue_T[] gtpName, globaldefs.NameAndStringValue_T[][] tpNames, String actionType, terminationPoint.GTP_THolder modifiedGTP) throws globaldefs.ProcessingFailureException;
...
} // interface ManagedElementMgr_IOperations
