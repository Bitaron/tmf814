...
/**
* managedElementManager/ManagedElementMgr_IPOA.java .
...
/**
   ...
   **/
public abstract class ManagedElementMgr_IPOA extends org.omg.PortableServer.Servant
 implements managedElementManager.ManagedElementMgr_IOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getContainingSubnetworkNames", new java.lang.Integer (2));
    _methods.put ("getAllPTPs", new java.lang.Integer (3));
    _methods.put ("getAllPTPsWithoutFTPs", new java.lang.Integer (4));
    _methods.put ("getAllFTPs", new java.lang.Integer (5));
    _methods.put ("getAllPTPNames", new java.lang.Integer (6));
    _methods.put ("getAllPTPNamesWithoutFTPs", new java.lang.Integer (7));
    _methods.put ("getAllFTPNames", new java.lang.Integer (8));
    _methods.put ("getTP", new java.lang.Integer (9));
    _methods.put ("getManagedElement", new java.lang.Integer (10));
    _methods.put ("getContainedPotentialTPs", new java.lang.Integer (11));
    _methods.put ("getContainedPotentialTPNames", new java.lang.Integer (12));
    _methods.put ("getContainedInUseTPs", new java.lang.Integer (13));
    _methods.put ("getContainedInUseTPNames", new java.lang.Integer (14));
    _methods.put ("getContainedCurrentTPs", new java.lang.Integer (15));
    _methods.put ("getContainedCurrentTPNames", new java.lang.Integer (16));
    _methods.put ("getContainingTPs", new java.lang.Integer (17));
    _methods.put ("getContainingTPNames", new java.lang.Integer (18));
    _methods.put ("getAllActiveAlarms", new java.lang.Integer (19));
    _methods.put ("getAllUnacknowledgedActiveAlarms", new java.lang.Integer (20));
    _methods.put ("setTPData", new java.lang.Integer (21));
    _methods.put ("getAllCrossConnections", new java.lang.Integer (22));
    _methods.put ("createGTP", new java.lang.Integer (23));
    _methods.put ("deleteGTP", new java.lang.Integer (24));
    _methods.put ("modifyGTP", new java.lang.Integer (25));
    _methods.put ("getGTP", new java.lang.Integer (26));
    _methods.put ("getAllGTPs", new java.lang.Integer (27));
    _methods.put ("getAllGTPNames", new java.lang.Integer (28));
    _methods.put ("getContainingGTP", new java.lang.Integer (29));
    _methods.put ("setGtpAlarmReportingOn", new java.lang.Integer (30));
    _methods.put ("setGtpAlarmReportingOff", new java.lang.Integer (31));
    _methods.put ("verifyTMDAssignment", new java.lang.Integer (32));
    _methods.put ("getAllFixedCrossConnections", new java.lang.Integer (33));
    _methods.put ("getPotentialFixedCCs", new java.lang.Integer (34));
  ...
  /**
     ...
     * <br>
     **/
       case 0:  // managedElementManager/ManagedElementMgr_I/getAllManagedElements
       {
         try {
           ...
           this.getAllManagedElements (how_many, meList, meIt);
           out = $rh.createReply();
  ...
  /**
     ...
     **/
       case 1:  // managedElementManager/ManagedElementMgr_I/getAllManagedElementNames
       {
         try {
           int how_many = in.read_ulong ();
           ...
           this.getAllManagedElementNames (how_many, nameList, nameIt);
           out = $rh.createReply();
  ...
  /** 
     ...
     * <br>
     **/
       case 2:  // managedElementManager/ManagedElementMgr_I/getContainingSubnetworkNames
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           globaldefs.NamingAttributesList_THolder subnetNames = new globaldefs.NamingAttributesList_THolder ();
           this.getContainingSubnetworkNames (managedElementName, subnetNames);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, subnetNames.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 3:  // managedElementManager/ManagedElementMgr_I/getAllPTPs
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           ...
           this.getAllPTPs (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
  ...
  /**
     ...
     * As for getAllPTPs().
     **/
       case 4:  // managedElementManager/ManagedElementMgr_I/getAllPTPsWithoutFTPs
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           terminationPoint.TerminationPointIterator_IHolder tpIt = new terminationPoint.TerminationPointIterator_IHolder ();
           this.getAllPTPsWithoutFTPs (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
           terminationPoint.TerminationPointIterator_IHelper.write (out, tpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * As for getAllPTPs().
     **/
       case 5:  // managedElementManager/ManagedElementMgr_I/getAllFTPs
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           terminationPoint.TerminationPointIterator_IHolder tpIt = new terminationPoint.TerminationPointIterator_IHolder ();
           this.getAllFTPs (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
           terminationPoint.TerminationPointIterator_IHelper.write (out, tpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * As for getAllPTPs().
     **/
       case 6:  // managedElementManager/ManagedElementMgr_I/getAllPTPNames
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getAllPTPNames (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * As for getAllPTPs().
     **/
       case 7:  // managedElementManager/ManagedElementMgr_I/getAllPTPNamesWithoutFTPs
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getAllPTPNamesWithoutFTPs (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * As for getAllPTPs().
     **/
       case 8:  // managedElementManager/ManagedElementMgr_I/getAllFTPNames
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getAllFTPNames (managedElementName, tpLayerRateList, connectionLayerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /** 
     ...
     * <br>
     **/
       case 9:  // managedElementManager/ManagedElementMgr_I/getTP
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           terminationPoint.TerminationPoint_THolder tp = new terminationPoint.TerminationPoint_THolder ();
           this.getTP (tpName, tp);
           out = $rh.createReply();
           terminationPoint.TerminationPoint_THelper.write (out, tp.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /** 
     ...
     * <br>
     **/
       case 10:  // managedElementManager/ManagedElementMgr_I/getManagedElement
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           managedElement.ManagedElement_THolder me = new managedElement.ManagedElement_THolder ();
           this.getManagedElement (managedElementName, me);
           out = $rh.createReply();
           managedElement.ManagedElement_THelper.write (out, me.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
    ...
    * <br>
     **/
       case 11:  // managedElementManager/ManagedElementMgr_I/getContainedPotentialTPs
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           ...
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           terminationPoint.TerminationPointIterator_IHolder tpIt = new terminationPoint.TerminationPointIterator_IHolder ();
           this.getContainedPotentialTPs (tpName, layerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
           terminationPoint.TerminationPointIterator_IHelper.write (out, tpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /** 
     ...
     **/
       case 12:  // managedElementManager/ManagedElementMgr_I/getContainedPotentialTPNames
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           short layerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getContainedPotentialTPNames (tpName, layerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /** 
     ...
     * <br>
     **/
       case 13:  // managedElementManager/ManagedElementMgr_I/getContainedInUseTPs
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           short layerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           terminationPoint.TerminationPointIterator_IHolder tpIt = new terminationPoint.TerminationPointIterator_IHolder ();
           this.getContainedInUseTPs (tpName, layerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
           terminationPoint.TerminationPointIterator_IHelper.write (out, tpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     **/
       case 14:  // managedElementManager/ManagedElementMgr_I/getContainedInUseTPNames
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           short layerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getContainedInUseTPNames (tpName, layerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /** 
     ...
     * <br>
     **/
       case 15:  // managedElementManager/ManagedElementMgr_I/getContainedCurrentTPs
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           short layerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           terminationPoint.TerminationPointIterator_IHolder tpIt = new terminationPoint.TerminationPointIterator_IHolder ();
           this.getContainedCurrentTPs (tpName, layerRateList, how_many, tpList, tpIt);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
           terminationPoint.TerminationPointIterator_IHelper.write (out, tpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     **/
       case 16:  // managedElementManager/ManagedElementMgr_I/getContainedCurrentTPNames
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           short layerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getContainedCurrentTPNames (tpName, layerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * <br>
     **/
       case 17:  // managedElementManager/ManagedElementMgr_I/getContainingTPs
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           terminationPoint.TerminationPointList_THolder tpList = new terminationPoint.TerminationPointList_THolder ();
           this.getContainingTPs (tpName, tpList);
           out = $rh.createReply();
           terminationPoint.TerminationPointList_THelper.write (out, tpList.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
  ...
  /**
     ...
     **/
       case 18:  // managedElementManager/ManagedElementMgr_I/getContainingTPNames
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           globaldefs.NamingAttributesList_THolder tpNameList = new globaldefs.NamingAttributesList_THolder ();
           this.getContainingTPNames (tpName, tpNameList);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, tpNameList.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 19:  // managedElementManager/ManagedElementMgr_I/getAllActiveAlarms
       {
         try {
           ...
           this.getAllActiveAlarms (meName, excludeProbCauseList, excludeSeverityList, how_many, eventList, eventIt);
           out = $rh.createReply();
  ...
  /**
     ...
     * <br>
     **/
       case 20:  // managedElementManager/ManagedElementMgr_I/getAllUnacknowledgedActiveAlarms
       {
         try {
           globaldefs.NameAndStringValue_T meName[] = globaldefs.NamingAttributes_THelper.read (in);
           String excludeProbCauseList[] = notifications.ProbableCauseList_THelper.read (in);
           ...
           notifications.EventList_THolder eventList = new notifications.EventList_THolder ();
           notifications.EventIterator_IHolder eventIt = new notifications.EventIterator_IHolder ();
           this.getAllUnacknowledgedActiveAlarms (meName, excludeProbCauseList, excludeSeverityList, how_many, eventList, eventIt);
           out = $rh.createReply();
           notifications.EventList_THelper.write (out, eventList.value);
           notifications.EventIterator_IHelper.write (out, eventIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /** 
     ...
     * <br>
     **/
       case 21:  // managedElementManager/ManagedElementMgr_I/setTPData
       {
         try {
           subnetworkConnection.TPData_T tpInfo = subnetworkConnection.TPData_THelper.read (in);
           terminationPoint.TerminationPoint_THolder modifiedTP = new terminationPoint.TerminationPoint_THolder ();
           this.setTPData (tpInfo, modifiedTP);
           out = $rh.createReply();
           terminationPoint.TerminationPoint_THelper.write (out, modifiedTP.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 22:  // managedElementManager/ManagedElementMgr_I/getAllCrossConnections
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short connectionRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           int how_many = in.read_ulong ();
           subnetworkConnection.CrossConnectList_THolder ccList = new subnetworkConnection.CrossConnectList_THolder ();
           subnetworkConnection.CCIterator_IHolder ccIt = new subnetworkConnection.CCIterator_IHolder ();
           this.getAllCrossConnections (managedElementName, connectionRateList, how_many, ccList, ccIt);
           out = $rh.createReply();
           subnetworkConnection.CrossConnectList_THelper.write (out, ccList.value);
           subnetworkConnection.CCIterator_IHelper.write (out, ccIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 23:  // managedElementManager/ManagedElementMgr_I/createGTP
       {
         try {
           String userLabel = in.read_string ();
           boolean forceUniqueness = in.read_boolean ();
           String owner = in.read_string ();
           globaldefs.NameAndStringValue_T listOfTPs[][] = globaldefs.NamingAttributesList_THelper.read (in);
           globaldefs.NameAndStringValue_T initialCTPname[] = globaldefs.NamingAttributes_THelper.read (in);
           int numberOfCTPs = in.read_ulong ();
           terminationPoint.GTPEffort_T gtpEffort = terminationPoint.GTPEffort_THelper.read (in);
           globaldefs.NameAndStringValue_T additionalCreationInfo[] = globaldefs.NVSList_THelper.read (in);
           terminationPoint.GTP_THolder newGTP = new terminationPoint.GTP_THolder ();
           this.createGTP (userLabel, forceUniqueness, owner, listOfTPs, initialCTPname, numberOfCTPs, gtpEffort, additionalCreationInfo, newGTP);
           out = $rh.createReply();
           terminationPoint.GTP_THelper.write (out, newGTP.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 24:  // managedElementManager/ManagedElementMgr_I/deleteGTP
       {
         try {
           globaldefs.NameAndStringValue_T gtpName[] = globaldefs.NamingAttributes_THelper.read (in);
           this.deleteGTP (gtpName);
           out = $rh.createReply();
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
  ...
  /**
     ...
     * <br>
     **/
       case 25:  // managedElementManager/ManagedElementMgr_I/modifyGTP
       {
         try {
           globaldefs.NameAndStringValue_T gtpName[] = globaldefs.NamingAttributes_THelper.read (in);
           globaldefs.NameAndStringValue_T tpNames[][] = globaldefs.NamingAttributesList_THelper.read (in);
           String actionType = in.read_string ();
           terminationPoint.GTP_THolder modifiedGTP = new terminationPoint.GTP_THolder ();
           this.modifyGTP (gtpName, tpNames, actionType, modifiedGTP);
           out = $rh.createReply();
           terminationPoint.GTP_THelper.write (out, modifiedGTP.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /** 
    ...
    * <br>
     **/
       case 26:  // managedElementManager/ManagedElementMgr_I/getGTP
       {
         try {
           globaldefs.NameAndStringValue_T gtpName[] = globaldefs.NamingAttributes_THelper.read (in);
           terminationPoint.GTP_THolder gtp = new terminationPoint.GTP_THolder ();
           this.getGTP (gtpName, gtp);
           out = $rh.createReply();
           terminationPoint.GTP_THelper.write (out, gtp.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     * <br>
     **/
       case 27:  // managedElementManager/ManagedElementMgr_I/getAllGTPs
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           terminationPoint.GTPiterator_IHolder gtpIt = new terminationPoint.GTPiterator_IHolder ();
           this.getAllGTPs (managedElementName, tpLayerRateList, how_many, gtpList, gtpIt);
           out = $rh.createReply();
           terminationPoint.GTPlist_THelper.write (out, gtpList.value);
           terminationPoint.GTPiterator_IHelper.write (out, gtpIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  /**
     ...
     **/
       case 28:  // managedElementManager/ManagedElementMgr_I/getAllGTPNames
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short tpLayerRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           globaldefs.NamingAttributesList_THolder nameList = new globaldefs.NamingAttributesList_THolder ();
           globaldefs.NamingAttributesIterator_IHolder nameIt = new globaldefs.NamingAttributesIterator_IHolder ();
           this.getAllGTPNames (managedElementName, tpLayerRateList, how_many, nameList, nameIt);
           out = $rh.createReply();
           globaldefs.NamingAttributesList_THelper.write (out, nameList.value);
           globaldefs.NamingAttributesIterator_IHelper.write (out, nameIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * <br>
     **/
       case 29:  // managedElementManager/ManagedElementMgr_I/getContainingGTP
       {
         try {
           globaldefs.NameAndStringValue_T ctpName[] = globaldefs.NamingAttributes_THelper.read (in);
           terminationPoint.GTP_THolder gtp = new terminationPoint.GTP_THolder ();
           this.getContainingGTP (ctpName, gtp);
           out = $rh.createReply();
           terminationPoint.GTP_THelper.write (out, gtp.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
  ...
  /**
     ...
     * <br>
     **/
       case 30:  // managedElementManager/ManagedElementMgr_I/setGtpAlarmReportingOn
       {
         try {
           globaldefs.NameAndStringValue_T gtpName[] = globaldefs.NamingAttributes_THelper.read (in);
           this.setGtpAlarmReportingOn (gtpName);
           out = $rh.createReply();
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
  ...
  /**
     ...
     * <br>
     **/
       case 31:  // managedElementManager/ManagedElementMgr_I/setGtpAlarmReportingOff
       {
         try {
           globaldefs.NameAndStringValue_T gtpName[] = globaldefs.NamingAttributes_THelper.read (in);
           this.setGtpAlarmReportingOff (gtpName);
           out = $rh.createReply();
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
  ...
  /**
     ...
     * <br>
     **/
       case 32:  // managedElementManager/ManagedElementMgr_I/verifyTMDAssignment
       {
         try {
           globaldefs.NameAndStringValue_T tpName[] = globaldefs.NamingAttributes_THelper.read (in);
           terminationPoint.Directionality_T direction = terminationPoint.Directionality_THelper.read (in);
           org.omg.CORBA.StringHolder tmdAssignmentState = new org.omg.CORBA.StringHolder ();
           ...
           this.verifyTMDAssignment (tpName, direction, tmdAssignmentState, transmissionParams, additionalTPInfo);
           out = $rh.createReply();
           out.write_string (tmdAssignmentState.value);
  ...
  /**
     ...
     * <br>
     **/
       case 33:  // managedElementManager/ManagedElementMgr_I/getAllFixedCrossConnections
       {
         try {
           globaldefs.NameAndStringValue_T managedElementName[] = globaldefs.NamingAttributes_THelper.read (in);
           short connectionRateList[] = transmissionParameters.LayerRateList_THelper.read (in);
           ...
           subnetworkConnection.CrossConnectList_THolder ccList = new subnetworkConnection.CrossConnectList_THolder ();
           subnetworkConnection.CCIterator_IHolder ccIt = new subnetworkConnection.CCIterator_IHolder ();
           this.getAllFixedCrossConnections (managedElementName, connectionRateList, how_many, ccList, ccIt);
           out = $rh.createReply();
           subnetworkConnection.CrossConnectList_THelper.write (out, ccList.value);
           subnetworkConnection.CCIterator_IHelper.write (out, ccIt.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
  ...
  /**
     ...
     * <br>
     **/
       case 34:  // managedElementManager/ManagedElementMgr_I/getPotentialFixedCCs
       {
         try {
           globaldefs.NameAndStringValue_T inputTP[] = globaldefs.NamingAttributes_THelper.read (in);
           globaldefs.NVSList_THolder ContainingTP = new globaldefs.NVSList_THolder ();
           globaldefs.NVSList_THolder potentialCCList = new globaldefs.NVSList_THolder ();
           this.getPotentialFixedCCs (inputTP, ContainingTP, potentialCCList);
           out = $rh.createReply();
           globaldefs.NamingAttributes_THelper.write (out, ContainingTP.value);
           globaldefs.NamingAttributes_THelper.write (out, potentialCCList.value);
         } catch (globaldefs.ProcessingFailureException $ex) {
           out = $rh.createExceptionReply ();
           globaldefs.ProcessingFailureExceptionHelper.write (out, $ex);
         }
  ...
  {
    return ManagedElementMgr_IHelper.narrow(
    super._this_object());
  }

  public ManagedElementMgr_I _this(org.omg.CORBA.ORB orb) 
  {
    return ManagedElementMgr_IHelper.narrow(
