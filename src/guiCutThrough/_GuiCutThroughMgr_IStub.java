...
/**
* guiCutThrough/_GuiCutThroughMgr_IStub.java .
...
/**
   ...
   **/
public class _GuiCutThroughMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements guiCutThrough.GuiCutThroughMgr_I
{
  ...
  public void getGCTProfileInfo (guiCutThrough.GCTProfileInfo_THolder gctProfileInfo) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getGCTProfileInfo", true);
                $in = _invoke ($out);
                gctProfileInfo.value = guiCutThrough.GCTProfileInfo_THelper.read ($in);
                return;
                ...
                getGCTProfileInfo (gctProfileInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // getGCTProfileInfo
  ...
  public void launchGCT (globaldefs.NameAndStringValue_T[] objectName, String gctContext, globaldefs.NameAndStringValue_T[] userInfo, String displayAddress, globaldefs.NameAndStringValue_T[] additionalInputInfo, org.omg.CORBA.BooleanHolder closingEnabled, globaldefs.NVSList_THolder additionalOutputInfo) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("launchGCT", true);
                globaldefs.NamingAttributes_THelper.write ($out, objectName);
                $out.write_string (gctContext);
                globaldefs.NVSList_THelper.write ($out, userInfo);
                $out.write_string (displayAddress);
                globaldefs.NVSList_THelper.write ($out, additionalInputInfo);
                $in = _invoke ($out);
                closingEnabled.value = $in.read_boolean ();
                additionalOutputInfo.value = globaldefs.NVSList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                launchGCT (objectName, gctContext, userInfo, displayAddress, additionalInputInfo, closingEnabled, additionalOutputInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // launchGCT
  ...
  /**
     ...
     * <br>
     **/
  public void destroyGCT (String displayAddress) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("destroyGCT", true);
                $out.write_string (displayAddress);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
