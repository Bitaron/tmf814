...
/**
* CosTrading/AdminOperations.java .
 ...
 */
public interface AdminOperations  extends CosTrading.TraderComponentsOperations, CosTrading.SupportAttributesOperations, CosTrading.ImportAttributesOperations, CosTrading.LinkAttributesOperations
{
   ...
   */
  CosTrading.FollowOption set_def_follow_policy (CosTrading.FollowOption policy);
   ...
   */
  CosTrading.FollowOption set_max_follow_policy (CosTrading.FollowOption policy);
   ...
   */
  CosTrading.FollowOption set_max_link_follow_policy (CosTrading.FollowOption policy);
  ...
  /* doc: 19 */
  void list_offers (int how_many, CosTrading.OfferIdSeqHolder ids, CosTrading.OfferIdIteratorHolder id_itr) throws CosTrading.NotImplemented;
   ...
   *  by the trader
   */
  void list_proxies (int how_many, CosTrading.OfferIdSeqHolder ids, CosTrading.OfferIdIteratorHolder id_itr) throws CosTrading.NotImplemented;
