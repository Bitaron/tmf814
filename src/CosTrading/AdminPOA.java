...
public abstract class AdminPOA extends org.omg.PortableServer.Servant
 implements CosTrading.AdminOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         byte $result[] = null;
         $result = this.request_id_stem ();
         out = $rh.createReply();
         CosTrading.AdminPackage.OctetSeqHelper.write (out, $result);
         break;
       }
   ...
   */
       case 1:  // CosTrading/Admin/set_def_search_card
       {
         ...
         int $result = (int)0;
         $result = this.set_def_search_card (value);
         out = $rh.createReply();
   ...
   */
       case 2:  // CosTrading/Admin/set_max_search_card
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_max_search_card (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 3:  // CosTrading/Admin/set_def_match_card
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_def_match_card (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 4:  // CosTrading/Admin/set_max_match_card
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_max_match_card (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 5:  // CosTrading/Admin/set_def_return_card
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_def_return_card (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 6:  // CosTrading/Admin/set_max_return_card
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_max_return_card (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 7:  // CosTrading/Admin/set_max_list
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_max_list (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 8:  // CosTrading/Admin/set_def_hop_count
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_def_hop_count (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 9:  // CosTrading/Admin/set_max_hop_count
       {
         int value = in.read_ulong ();
         int $result = (int)0;
         $result = this.set_max_hop_count (value);
         out = $rh.createReply();
         out.write_ulong ($result);
         break;
       }
   ...
   */
       case 10:  // CosTrading/Admin/set_supports_modifiable_properties
       {
         ...
         $result = this.set_supports_modifiable_properties (value);
         out = $rh.createReply();
   ...
   */
       case 11:  // CosTrading/Admin/set_supports_dynamic_properties
       {
         boolean value = in.read_boolean ();
         boolean $result = false;
         $result = this.set_supports_dynamic_properties (value);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
   ...
   */
       case 12:  // CosTrading/Admin/set_supports_proxy_offers
       {
         boolean value = in.read_boolean ();
         boolean $result = false;
         $result = this.set_supports_proxy_offers (value);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
   ...
   */
       ...
       {
         CosTrading.FollowOption policy = CosTrading.FollowOptionHelper.read (in);
         CosTrading.FollowOption $result = null;
         $result = this.set_def_follow_policy (policy);
         out = $rh.createReply();
   ...
   */
       case 14:  // CosTrading/Admin/set_max_follow_policy
       {
         CosTrading.FollowOption policy = CosTrading.FollowOptionHelper.read (in);
         CosTrading.FollowOption $result = null;
         $result = this.set_max_follow_policy (policy);
         out = $rh.createReply();
         CosTrading.FollowOptionHelper.write (out, $result);
         break;
       }
   ...
   */
       case 15:  // CosTrading/Admin/set_max_link_follow_policy
       {
         CosTrading.FollowOption policy = CosTrading.FollowOptionHelper.read (in);
         CosTrading.FollowOption $result = null;
         $result = this.set_max_link_follow_policy (policy);
         out = $rh.createReply();
         CosTrading.FollowOptionHelper.write (out, $result);
         break;
       }
   ...
   */
       ...
       {
         org.omg.CORBA.Object repository = CosTrading.TypeRepositoryHelper.read (in);
         org.omg.CORBA.Object $result = null;
         $result = this.set_type_repos (repository);
         out = $rh.createReply();
   ...
   */
       ...
       {
         byte stem[] = CosTrading.AdminPackage.OctetSeqHelper.read (in);
         byte $result[] = null;
         $result = this.set_request_id_stem (stem);
         out = $rh.createReply();
         CosTrading.AdminPackage.OctetSeqHelper.write (out, $result);
         break;
       }
  ...
  /* doc: 19 */
       case 18:  // CosTrading/Admin/list_offers
       {
         try {
           ...
           CosTrading.OfferIdIteratorHolder id_itr = new CosTrading.OfferIdIteratorHolder ();
           this.list_offers (how_many, ids, id_itr);
           out = $rh.createReply();
           CosTrading.OfferIdSeqHelper.write (out, ids.value);
           CosTrading.OfferIdIteratorHelper.write (out, id_itr.value);
