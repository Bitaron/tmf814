...
/**
* transmissionDescriptor/ServiceCategory_THelper.java .
...
{
  private static String  _id = "IDL:mtnm.tmforum.org/transmissionDescriptor/ServiceCategory_T:1.0";

  public static void insert (org.omg.CORBA.Any a, transmissionDescriptor.ServiceCategory_T that)
  {
  ...
  public static transmissionDescriptor.ServiceCategory_T extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_enum_tc (transmissionDescriptor.ServiceCategory_THelper.id (), "ServiceCategory_T", new String[] { "SC_CBR", "SC_VBRRT", "SC_VBRNRT", "SC_ABR", "SC_UBR", "SC_GFR", "SC_NA"} );
    }
    return __typeCode;
  }
  ...
  public static transmissionDescriptor.ServiceCategory_T read (org.omg.CORBA.portable.InputStream istream)
  {
    return transmissionDescriptor.ServiceCategory_T.from_int (istream.read_long ());
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, transmissionDescriptor.ServiceCategory_T value)
  {
