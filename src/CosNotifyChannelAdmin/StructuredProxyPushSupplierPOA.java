...
/**
* CosNotifyChannelAdmin/StructuredProxyPushSupplierPOA.java .
...
/**
    ...
    */
public abstract class StructuredProxyPushSupplierPOA extends org.omg.PortableServer.Servant
 implements CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_structured_push_consumer", new java.lang.Integer (0));
    ...
    _methods.put ("disconnect_structured_push_supplier", new java.lang.Integer (19));
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/StructuredProxyPushSupplier/connect_structured_push_consumer
       {
         try {
           CosNotifyComm.StructuredPushConsumer push_consumer = CosNotifyComm.StructuredPushConsumerHelper.read (in);
           this.connect_structured_push_consumer (push_consumer);
           out = $rh.createReply();
  ...
  /**
         ...
         */
       case 1:  // CosNotifyChannelAdmin/StructuredProxyPushSupplier/suspend_connection
       {
         try {
  ...
  /**
         ...
         * @raises NotConnected Proxy not connected.
         */
       case 2:  // CosNotifyChannelAdmin/StructuredProxyPushSupplier/resume_connection
       {
         try {
  ...
  /**
         ...
         */
       case 19:  // CosNotifyComm/StructuredPushSupplier/disconnect_structured_push_supplier
       {
  ...
  {
    return StructuredProxyPushSupplierHelper.narrow(
    super._this_object());
  }

  public StructuredProxyPushSupplier _this(org.omg.CORBA.ORB orb) 
  {
    return StructuredProxyPushSupplierHelper.narrow(
