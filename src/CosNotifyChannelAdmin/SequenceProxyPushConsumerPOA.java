...
/**
* CosNotifyChannelAdmin/SequenceProxyPushConsumerPOA.java .
...
/**
    ...
    */
public abstract class SequenceProxyPushConsumerPOA extends org.omg.PortableServer.Servant
 implements CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_sequence_push_supplier", new java.lang.Integer (0));
    ...
    _methods.put ("push_structured_events", new java.lang.Integer (13));
    _methods.put ("disconnect_sequence_push_consumer", new java.lang.Integer (14));
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/SequenceProxyPushConsumer/connect_sequence_push_supplier
       {
         try {
           CosNotifyComm.SequencePushSupplier push_supplier = CosNotifyComm.SequencePushSupplierHelper.read (in);
           this.connect_sequence_push_supplier (push_supplier);
           out = $rh.createReply();
  ...
  /**
         ...
         */
       case 13:  // CosNotifyComm/SequencePushConsumer/push_structured_events
       {
         try {
  ...
  /**
         ...
         */
       case 14:  // CosNotifyComm/SequencePushConsumer/disconnect_sequence_push_consumer
       {
  ...
  {
    return SequenceProxyPushConsumerHelper.narrow(
    super._this_object());
  }
