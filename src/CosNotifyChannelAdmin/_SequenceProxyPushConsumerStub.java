...
/**
* CosNotifyChannelAdmin/_SequenceProxyPushConsumerStub.java .
...
/**
    ...
    */
public class _SequenceProxyPushConsumerStub extends org.omg.CORBA.portable.ObjectImpl implements CosNotifyChannelAdmin.SequenceProxyPushConsumer
{
  ...
  /**
         ...
         */
  public void connect_sequence_push_supplier (CosNotifyComm.SequencePushSupplier push_supplier) throws CosEventChannelAdmin.AlreadyConnected
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("connect_sequence_push_supplier", true);
                CosNotifyComm.SequencePushSupplierHelper.write ($out, push_supplier);
                $in = _invoke ($out);
                return;
  ...
  /**
         ...
         */
  public void push_structured_events (CosNotification.StructuredEvent[] notifications) throws CosEventComm.Disconnected
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("push_structured_events", true);
                CosNotification.EventBatchHelper.write ($out, notifications);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
