...
/**
* CosNotifyChannelAdmin/ProxyConsumerPOA.java .
...
public abstract class ProxyConsumerPOA extends org.omg.PortableServer.Servant
 implements CosNotifyChannelAdmin.ProxyConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("obtain_subscription_types", new java.lang.Integer (2));
    _methods.put ("validate_event_qos", new java.lang.Integer (3));
    _methods.put ("get_qos", new java.lang.Integer (4));
    _methods.put ("set_qos", new java.lang.Integer (5));
    _methods.put ("validate_qos", new java.lang.Integer (6));
    _methods.put ("add_filter", new java.lang.Integer (7));
    _methods.put ("remove_filter", new java.lang.Integer (8));
    _methods.put ("get_filter", new java.lang.Integer (9));
    _methods.put ("get_all_filters", new java.lang.Integer (10));
    _methods.put ("remove_all_filters", new java.lang.Integer (11));
  }
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/ProxyConsumer/_get_MyType
       {
  ...
  /**
         ...
         */
       case 1:  // CosNotifyChannelAdmin/ProxyConsumer/_get_MyAdmin
       {
  ...
  /**
         ...
         */
       case 2:  // CosNotifyChannelAdmin/ProxyConsumer/obtain_subscription_types
       {
  ...
  /**
         ...
         */
       case 3:  // CosNotifyChannelAdmin/ProxyConsumer/validate_event_qos
       {
         try {
  ...
  /**
         ...
         * service settings.
         */
       case 4:  // CosNotification/QoSAdmin/get_qos
       {
  ...
  /**
         ...
         */
       case 5:  // CosNotification/QoSAdmin/set_qos
       {
         try {
  ...
  /**
         ...
         * are not supported.
         */
       case 6:  // CosNotification/QoSAdmin/validate_qos
       {
         try {
           CosNotification.Property required_qos[] = CosNotification.QoSPropertiesHelper.read (in);
           CosNotification.NamedPropertyRangeSeqHolder available_qos = new CosNotification.NamedPropertyRangeSeqHolder ();
  ...
  /**
         ...
         */
       case 7:  // CosNotifyFilter/FilterAdmin/add_filter
       {
  ...
  /**
         ...
         */
       case 8:  // CosNotifyFilter/FilterAdmin/remove_filter
       {
         try {
  ...
  /**
         ...
         * filter that has been added to this object.
         */
       case 9:  // CosNotifyFilter/FilterAdmin/get_filter
       {
         try {
           int filter = CosNotifyFilter.FilterIDHelper.read (in);
  ...
  /**
         ...
         */
       case 10:  // CosNotifyFilter/FilterAdmin/get_all_filters
       {
         int $result[] = null;
  ...
  /**
         ...
         */
       case 11:  // CosNotifyFilter/FilterAdmin/remove_all_filters
       {
