...
/**
* CosNotifyChannelAdmin/StructuredProxyPullSupplierPOA.java .
...
/**
    ...
    */
public abstract class StructuredProxyPullSupplierPOA extends org.omg.PortableServer.Servant
 implements CosNotifyChannelAdmin.StructuredProxyPullSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_structured_pull_consumer", new java.lang.Integer (0));
    ...
    _methods.put ("pull_structured_event", new java.lang.Integer (17));
    _methods.put ("try_pull_structured_event", new java.lang.Integer (18));
    _methods.put ("disconnect_structured_pull_supplier", new java.lang.Integer (19));
    _methods.put ("subscription_change", new java.lang.Integer (20));
  }
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/StructuredProxyPullSupplier/connect_structured_pull_consumer
       {
         try {
           CosNotifyComm.StructuredPullConsumer pull_consumer = CosNotifyComm.StructuredPullConsumerHelper.read (in);
           this.connect_structured_pull_consumer (pull_consumer);
           out = $rh.createReply();
  ...
  /**
         ...
         */
       case 17:  // CosNotifyComm/StructuredPullSupplier/pull_structured_event
       {
         try {
  ...
  /**
         ...
         * @raises Disconnected If this supplier is disconnected.
         */
       case 18:  // CosNotifyComm/StructuredPullSupplier/try_pull_structured_event
       {
         try {
  ...
  /**
         ...
         */
       case 19:  // CosNotifyComm/StructuredPullSupplier/disconnect_structured_pull_supplier
       {
  ...
  /**
         ...
         */
       case 20:  // CosNotifyComm/NotifySubscribe/subscription_change
       {
         try {
  ...
  {
    return StructuredProxyPullSupplierHelper.narrow(
    super._this_object());
  }
