...
/**
* CosNotifyChannelAdmin/ProxyPushConsumerPOA.java .
...
public abstract class ProxyPushConsumerPOA extends org.omg.PortableServer.Servant
 implements CosNotifyChannelAdmin.ProxyPushConsumerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_any_push_supplier", new java.lang.Integer (0));
    ...
    _methods.put ("offer_change", new java.lang.Integer (13));
    _methods.put ("push", new java.lang.Integer (14));
    _methods.put ("disconnect_push_consumer", new java.lang.Integer (15));
  }
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/ProxyPushConsumer/connect_any_push_supplier
       {
         try {
           CosEventComm.PushSupplier push_supplier = CosEventComm.PushSupplierHelper.read (in);
           this.connect_any_push_supplier (push_supplier);
           out = $rh.createReply();
  ...
  /**
         ...
         */
       case 13:  // CosNotifyComm/NotifyPublish/offer_change
       {
         try {
  ...
  /**
         ...
         */
       case 14:  // CosEventComm/PushConsumer/push
       {
         try {
  ...
  /**
         ...
         */
       case 15:  // CosEventComm/PushConsumer/disconnect_push_consumer
       {
