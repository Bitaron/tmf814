 ...
 implements CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_sequence_pull_consumer", new java.lang.Integer (0));
    ...
    _methods.put ("pull_structured_events", new java.lang.Integer (17));
    _methods.put ("try_pull_structured_events", new java.lang.Integer (18));
    _methods.put ("disconnect_sequence_pull_supplier", new java.lang.Integer (19));
  ...
  /**
         ...
         */
       case 0:  // CosNotifyChannelAdmin/SequenceProxyPullSupplier/connect_sequence_pull_consumer
       {
         try {
           CosNotifyComm.SequencePullConsumer pull_consumer = CosNotifyComm.SequencePullConsumerHelper.read (in);
           this.connect_sequence_pull_consumer (pull_consumer);
           out = $rh.createReply();
  ...
  /**
         ...
         */
       case 17:  // CosNotifyComm/SequencePullSupplier/pull_structured_events
       {
         try {
  ...
  /**
         ...
         * @raises Disconnected If this supplier is disconnected.
         */
       case 18:  // CosNotifyComm/SequencePullSupplier/try_pull_structured_events
       {
         try {
           int max_number = in.read_long ();
  ...
  /**
         ...
         */
       case 19:  // CosNotifyComm/SequencePullSupplier/disconnect_sequence_pull_supplier
       {
