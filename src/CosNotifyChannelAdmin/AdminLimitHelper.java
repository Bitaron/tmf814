...
/**
* CosNotifyChannelAdmin/AdminLimitHelper.java .
...
abstract public class AdminLimitHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, CosNotifyChannelAdmin.AdminLimit that)
  {
  ...
  public static CosNotifyChannelAdmin.AdminLimit extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (CosNotifyChannelAdmin.AdminLimitHelper.id (), "AdminLimit", _members0);
          __active = false;
        }
      }
    }
  ...
  public static CosNotifyChannelAdmin.AdminLimit read (org.omg.CORBA.portable.InputStream istream)
  {
    CosNotifyChannelAdmin.AdminLimit value = new CosNotifyChannelAdmin.AdminLimit ();
    value.name = istream.read_string ();
    value.value = istream.read_any ();
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, CosNotifyChannelAdmin.AdminLimit value)
  {
