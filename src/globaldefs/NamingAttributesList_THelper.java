...
/**
* globaldefs/NamingAttributesList_THelper.java .
...
/**
   ...
   **/
abstract public class NamingAttributesList_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/globaldefs/NamingAttributesList_T:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (globaldefs.NamingAttributesList_THelper.id (), "NamingAttributesList_T", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static globaldefs.NameAndStringValue_T[][] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = globaldefs.NamingAttributes_THelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, globaldefs.NameAndStringValue_T[][] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      globaldefs.NamingAttributes_THelper.write (ostream, value[_i0]);
  }
