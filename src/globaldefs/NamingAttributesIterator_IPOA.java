...
/**
* globaldefs/NamingAttributesIterator_IPOA.java .
...
/**
   ...
   **/
public abstract class NamingAttributesIterator_IPOA extends org.omg.PortableServer.Servant
 implements globaldefs.NamingAttributesIterator_IOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // globaldefs/NamingAttributesIterator_I/next_n
       {
         try {
           ...
           $result = this.next_n (how_many, nameList);
           out = $rh.createReply();
       ...
       case 1:  // globaldefs/NamingAttributesIterator_I/getLength
       {
         try {
           int $result = (int)0;
       ...
       case 2:  // globaldefs/NamingAttributesIterator_I/destroy
       {
         try {
           this.destroy ();
           out = $rh.createReply();
  ...
  {
    return NamingAttributesIterator_IHelper.narrow(
    super._this_object());
  }

  public NamingAttributesIterator_I _this(org.omg.CORBA.ORB orb) 
  {
    return NamingAttributesIterator_IHelper.narrow(
...
} // class NamingAttributesIterator_IPOA
