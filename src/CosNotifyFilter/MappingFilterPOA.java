 ...
 implements CosNotifyFilter.MappingFilterOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_value_type", new java.lang.Integer (1));
    _methods.put ("_get_default_value", new java.lang.Integer (2));
    _methods.put ("add_mapping_constraints", new java.lang.Integer (3));
    _methods.put ("modify_mapping_constraints", new java.lang.Integer (4));
    _methods.put ("get_mapping_constraints", new java.lang.Integer (5));
    _methods.put ("get_all_mapping_constraints", new java.lang.Integer (6));
    _methods.put ("remove_all_mapping_constraints", new java.lang.Integer (7));
    _methods.put ("destroy", new java.lang.Integer (8));
    _methods.put ("match", new java.lang.Integer (9));
    _methods.put ("match_structured", new java.lang.Integer (10));
    _methods.put ("match_typed", new java.lang.Integer (11));
  }
  ...
  /**
         ...
         * to affect.
         */
       case 1:  // CosNotifyFilter/MappingFilter/_get_value_type
       {
  ...
  /**
         ...
         */
       case 2:  // CosNotifyFilter/MappingFilter/_get_default_value
       {
  ...
  /**
         ...
         */
       case 3:  // CosNotifyFilter/MappingFilter/add_mapping_constraints
       {
         try {
  ...
  /**
         ...
         */
       case 4:  // CosNotifyFilter/MappingFilter/modify_mapping_constraints
       {
         try {
  ...
  /**
         ...
         */
       case 5:  // CosNotifyFilter/MappingFilter/get_mapping_constraints
       {
         try {
  ...
  /**
         ...
         */
       case 6:  // CosNotifyFilter/MappingFilter/get_all_mapping_constraints
       {
         CosNotifyFilter.MappingConstraintInfo $result[] = null;
  ...
  /**
         ...
         */
       case 7:  // CosNotifyFilter/MappingFilter/remove_all_mapping_constraints
       {
  ...
  /**
         ...
         */
       case 8:  // CosNotifyFilter/MappingFilter/destroy
       {
         this.destroy ();
         out = $rh.createReply();
         break;
  ...
  /**
         ...
         */
       case 9:  // CosNotifyFilter/MappingFilter/match
       {
         try {
  ...
  /**
         ...
         * not designed to handle.
         */
       case 10:  // CosNotifyFilter/MappingFilter/match_structured
       {
         try {
  ...
  /**
         ...
         * not designed to handle.
         */
       case 11:  // CosNotifyFilter/MappingFilter/match_typed
       {
         try {
