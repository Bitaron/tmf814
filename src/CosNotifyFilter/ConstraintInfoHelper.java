...
/**
* CosNotifyFilter/ConstraintInfoHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from CosNotifyFilter.idl
* Wednesday, June 15, 2016 7:24:33 PM COT
*/

abstract public class ConstraintInfoHelper
{
  private static String  _id = "IDL:omg.org/CosNotifyFilter/ConstraintInfo:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (CosNotifyFilter.ConstraintInfoHelper.id (), "ConstraintInfo", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    CosNotifyFilter.ConstraintInfo value = new CosNotifyFilter.ConstraintInfo ();
