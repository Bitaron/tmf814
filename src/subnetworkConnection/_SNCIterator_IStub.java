...
/**
* subnetworkConnection/_SNCIterator_IStub.java .
...
/**
   ...
   **/
public class _SNCIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements subnetworkConnection.SNCIterator_I
{
  ...
  public boolean next_n (int how_many, subnetworkConnection.SubnetworkConnectionList_THolder sncList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                return next_n (how_many, sncList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
