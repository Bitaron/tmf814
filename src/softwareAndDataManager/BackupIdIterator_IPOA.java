...
/**
* softwareAndDataManager/BackupIdIterator_IPOA.java .
...
/**
   ...
   * Ids.</p>
   **/
public abstract class BackupIdIterator_IPOA extends org.omg.PortableServer.Servant
 implements softwareAndDataManager.BackupIdIterator_IOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // softwareAndDataManager/BackupIdIterator_I/next_n
       {
         try {
           ...
           $result = this.next_n (how_many, backupList);
           out = $rh.createReply();
       ...
       case 1:  // softwareAndDataManager/BackupIdIterator_I/getLength
       {
         try {
           int $result = (int)0;
       ...
       case 2:  // softwareAndDataManager/BackupIdIterator_I/destroy
       {
         try {
           this.destroy ();
           out = $rh.createReply();
  ...
  private static String[] __ids = {
    "IDL:mtnm.tmforum.org/softwareAndDataManager/BackupIdIterator_I:1.0"};
  ...
  {
    return BackupIdIterator_IHelper.narrow(
    super._this_object());
  }

  public BackupIdIterator_I _this(org.omg.CORBA.ORB orb) 
  {
    return BackupIdIterator_IHelper.narrow(
