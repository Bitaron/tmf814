...
/**
* CosNaming/NameComponentHelper.java .
...
abstract public class NameComponentHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (CosNaming.IstringHelper.id (), "Istring", _tcOf_members0);
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (CosNaming.NameComponentHelper.id (), "NameComponent", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    CosNaming.NameComponent value = new CosNaming.NameComponent ();
