...
/**
* DsNotifyLogAdmin/NotifyLogFactoryPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DsNotifyLogAdmin.idl
* Wednesday, June 15, 2016 7:24:34 PM COT
*/

public abstract class NotifyLogFactoryPOA extends org.omg.PortableServer.Servant
 implements DsNotifyLogAdmin.NotifyLogFactoryOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_MyID", new java.lang.Integer (5));
    _methods.put ("_get_MyChannel", new java.lang.Integer (6));
    _methods.put ("_get_MyOperator", new java.lang.Integer (7));
    _methods.put ("_get_priority_filter", new java.lang.Integer (8));
    _methods.put ("_set_priority_filter", new java.lang.Integer (9));
    _methods.put ("_get_lifetime_filter", new java.lang.Integer (10));
    _methods.put ("_set_lifetime_filter", new java.lang.Integer (11));
    _methods.put ("_get_pull_suppliers", new java.lang.Integer (12));
    _methods.put ("_get_push_suppliers", new java.lang.Integer (13));
    _methods.put ("get_proxy_supplier", new java.lang.Integer (14));
    _methods.put ("obtain_notification_pull_supplier", new java.lang.Integer (15));
    _methods.put ("obtain_notification_push_supplier", new java.lang.Integer (16));
    _methods.put ("destroy", new java.lang.Integer (17));
    _methods.put ("get_qos", new java.lang.Integer (18));
    _methods.put ("set_qos", new java.lang.Integer (19));
    _methods.put ("validate_qos", new java.lang.Integer (20));
    _methods.put ("subscription_change", new java.lang.Integer (21));
    _methods.put ("add_filter", new java.lang.Integer (22));
    _methods.put ("remove_filter", new java.lang.Integer (23));
    _methods.put ("get_filter", new java.lang.Integer (24));
    _methods.put ("get_all_filters", new java.lang.Integer (25));
    _methods.put ("remove_all_filters", new java.lang.Integer (26));
    _methods.put ("obtain_push_supplier", new java.lang.Integer (27));
    _methods.put ("obtain_pull_supplier", new java.lang.Integer (28));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // DsNotifyLogAdmin/NotifyLogFactory/create
       {
         try {
           ...
           DsNotifyLogAdmin.NotifyLog $result = null;
           $result = this.create (full_action, max_size, thresholds, initial_qos, initial_admin, id);
           out = $rh.createReply();
           DsNotifyLogAdmin.NotifyLogHelper.write (out, $result);
       ...
       case 1:  // DsNotifyLogAdmin/NotifyLogFactory/create_with_id
       {
         try {
           ...
           CosNotification.Property initial_admin[] = CosNotification.AdminPropertiesHelper.read (in);
           DsNotifyLogAdmin.NotifyLog $result = null;
           $result = this.create_with_id (id, full_action, max_size, thresholds, initial_qos, initial_admin);
           out = $rh.createReply();
           DsNotifyLogAdmin.NotifyLogHelper.write (out, $result);
  ...
  /**
         ...
         */
       case 5:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_MyID
       {
         int $result = (int)0;
         $result = this.MyID ();
         out = $rh.createReply();
  ...
  /**
         ...
         */
       case 6:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_MyChannel
       {
  ...
  /**
         ...
         */
       case 7:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_MyOperator
       {
  ...
  /**
         ...
         */
       case 8:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_priority_filter
       {
  ...
  /**
         ...
         * for resolving the priority of the event.
         */
       case 9:  // CosNotifyChannelAdmin/ConsumerAdmin/_set_priority_filter
       {
  ...
  /**
         ...
         */
       case 10:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_lifetime_filter
       {
         CosNotifyFilter.MappingFilter $result = null;
  ...
  /**
         ...
         * for resolving the lifetime of the event.
         */
       case 11:  // CosNotifyChannelAdmin/ConsumerAdmin/_set_lifetime_filter
       {
  ...
  /**
         ...
         */
       case 12:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_pull_suppliers
       {
         int $result[] = null;
  ...
  /**
         ...
         */
       case 13:  // CosNotifyChannelAdmin/ConsumerAdmin/_get_push_suppliers
       {
         int $result[] = null;
  ...
  /**
         ...
         * be found.
         */
       case 14:  // CosNotifyChannelAdmin/ConsumerAdmin/get_proxy_supplier
       {
         try {
  ...
  /**
         ...
         */
       case 15:  // CosNotifyChannelAdmin/ConsumerAdmin/obtain_notification_pull_supplier
       {
         try {
  ...
  /**
         ...
         * with this administration object exceeds the MaxConsumers property.
         */
       case 16:  // CosNotifyChannelAdmin/ConsumerAdmin/obtain_notification_push_supplier
       {
         try {
           CosNotifyChannelAdmin.ClientType ctype = CosNotifyChannelAdmin.ClientTypeHelper.read (in);
           org.omg.CORBA.IntHolder proxy_id = new org.omg.CORBA.IntHolder ();
  ...
  /**
         ...
         */
       case 17:  // CosNotifyChannelAdmin/ConsumerAdmin/destroy
       {
         this.destroy ();
         out = $rh.createReply();
         break;
  ...
  /**
         ...
         * service settings.
         */
       case 18:  // CosNotification/QoSAdmin/get_qos
       {
  ...
  /**
         ...
         */
       case 19:  // CosNotification/QoSAdmin/set_qos
       {
         try {
  ...
  /**
         ...
         * are not supported.
         */
       case 20:  // CosNotification/QoSAdmin/validate_qos
       {
         try {
  ...
  /**
         ...
         */
       case 21:  // CosNotifyComm/NotifySubscribe/subscription_change
       {
         try {
  ...
  /**
         ...
         */
       case 22:  // CosNotifyFilter/FilterAdmin/add_filter
       {
  ...
  /**
         ...
         */
       case 23:  // CosNotifyFilter/FilterAdmin/remove_filter
       {
         try {
  ...
  /**
         ...
         * filter that has been added to this object.
         */
       case 24:  // CosNotifyFilter/FilterAdmin/get_filter
       {
         try {
           int filter = CosNotifyFilter.FilterIDHelper.read (in);
  ...
  /**
         ...
         */
       case 25:  // CosNotifyFilter/FilterAdmin/get_all_filters
       {
         int $result[] = null;
  ...
  /**
         ...
         */
       case 26:  // CosNotifyFilter/FilterAdmin/remove_all_filters
       {
  ...
  /**
         ...
         */
       case 27:  // CosEventChannelAdmin/ConsumerAdmin/obtain_push_supplier
       {
  ...
  /**
         ...
         */
       case 28:  // CosEventChannelAdmin/ConsumerAdmin/obtain_pull_supplier
       {
  ...
  public NotifyLogFactory _this() 
  {
    return NotifyLogFactoryHelper.narrow(
    super._this_object());
  }

  public NotifyLogFactory _this(org.omg.CORBA.ORB orb) 
  {
    return NotifyLogFactoryHelper.narrow(
