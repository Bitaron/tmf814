...
/**
* DsNotifyLogAdmin/_NotifyLogFactoryStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DsNotifyLogAdmin.idl
* Wednesday, June 15, 2016 7:24:34 PM COT
*/

public class _NotifyLogFactoryStub extends org.omg.CORBA.portable.ObjectImpl implements DsNotifyLogAdmin.NotifyLogFactory
{

  public DsNotifyLogAdmin.NotifyLog create (short full_action, long max_size, short[] thresholds, CosNotification.Property[] initial_qos, CosNotification.Property[] initial_admin, org.omg.CORBA.IntHolder id) throws DsLogAdmin.InvalidLogFullAction, DsLogAdmin.InvalidThreshold, CosNotification.UnsupportedQoS, CosNotification.UnsupportedAdmin
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                DsNotifyLogAdmin.NotifyLog $result = DsNotifyLogAdmin.NotifyLogHelper.read ($in);
                ...
                return create (full_action, max_size, thresholds, initial_qos, initial_admin, id        );
            } finally {
                _releaseReply ($in);
            }
  } // create

  public DsNotifyLogAdmin.NotifyLog create_with_id (int id, short full_action, long max_size, short[] thresholds, CosNotification.Property[] initial_qos, CosNotification.Property[] initial_admin) throws DsLogAdmin.LogIdAlreadyExists, DsLogAdmin.InvalidLogFullAction, DsLogAdmin.InvalidThreshold, CosNotification.UnsupportedQoS, CosNotification.UnsupportedAdmin
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return create_with_id (id, full_action, max_size, thresholds, initial_qos, initial_admin        );
            } finally {
                _releaseReply ($in);
            }
  } // create_with_id
