...
/**
* notifications/_EventIterator_IStub.java .
...
/**
   ...
   **/
public class _EventIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements notifications.EventIterator_I
{
  ...
  public boolean next_n (int how_many, notifications.EventList_THolder eventList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                return next_n (how_many, eventList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
