...
/**
* notifications/NameAndAnyValue_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from notifications.idl
* Wednesday, June 15, 2016 7:24:40 PM COT
*/

abstract public class NameAndAnyValue_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/notifications/NameAndAnyValue_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (notifications.NameAndAnyValue_THelper.id (), "NameAndAnyValue_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    notifications.NameAndAnyValue_T value = new notifications.NameAndAnyValue_T ();
