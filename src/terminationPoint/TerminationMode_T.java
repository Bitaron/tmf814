...
/**
* terminationPoint/TerminationMode_T.java .
...
/**
   ...
   **/
public class TerminationMode_T implements org.omg.CORBA.portable.IDLEntity
{
  private        int __value;
  private static int __size = 3;
  private static terminationPoint.TerminationMode_T[] __array = new terminationPoint.TerminationMode_T [__size];

  public static final int _TM_NA = 0;
  public static final terminationPoint.TerminationMode_T TM_NA = new terminationPoint.TerminationMode_T(_TM_NA);
  public static final int _TM_NEITHER_TERMINATED_NOR_AVAILABLE_FOR_MAPPING = 1;
  public static final terminationPoint.TerminationMode_T TM_NEITHER_TERMINATED_NOR_AVAILABLE_FOR_MAPPING = new terminationPoint.TerminationMode_T(_TM_NEITHER_TERMINATED_NOR_AVAILABLE_FOR_MAPPING);
  public static final int _TM_TERMINATED_AND_AVAILABLE_FOR_MAPPING = 2;
  public static final terminationPoint.TerminationMode_T TM_TERMINATED_AND_AVAILABLE_FOR_MAPPING = new terminationPoint.TerminationMode_T(_TM_TERMINATED_AND_AVAILABLE_FOR_MAPPING);
  ...
  public static terminationPoint.TerminationMode_T from_int (int value)
  {
  ...
  protected TerminationMode_T (int value)
  {
    __value = value;
    __array[__value] = this;
  }
} // class TerminationMode_T
