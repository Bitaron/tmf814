...
/**
* DsLogAdmin/AnysHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DsLogAdmin.idl
* Wednesday, June 15, 2016 7:24:34 PM COT
*/

abstract public class AnysHelper
{
  private static String  _id = "IDL:omg.org/DsLogAdmin/Anys:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (DsLogAdmin.AnysHelper.id (), "Anys", __typeCode);
    }
    return __typeCode;
  }
