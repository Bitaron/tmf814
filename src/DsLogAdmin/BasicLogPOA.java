...
/**
* DsLogAdmin/BasicLogPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DsLogAdmin.idl
* Wednesday, June 15, 2016 7:24:34 PM COT
*/

public abstract class BasicLogPOA extends org.omg.PortableServer.Servant
 implements DsLogAdmin.BasicLogOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("my_factory", new java.lang.Integer (1));
    _methods.put ("id", new java.lang.Integer (2));
    _methods.put ("get_log_qos", new java.lang.Integer (3));
    _methods.put ("set_log_qos", new java.lang.Integer (4));
    _methods.put ("get_max_record_life", new java.lang.Integer (5));
    _methods.put ("set_max_record_life", new java.lang.Integer (6));
    _methods.put ("get_max_size", new java.lang.Integer (7));
    _methods.put ("set_max_size", new java.lang.Integer (8));
    _methods.put ("get_current_size", new java.lang.Integer (9));
    _methods.put ("get_n_records", new java.lang.Integer (10));
    _methods.put ("get_log_full_action", new java.lang.Integer (11));
    _methods.put ("set_log_full_action", new java.lang.Integer (12));
    _methods.put ("get_administrative_state", new java.lang.Integer (13));
    _methods.put ("set_administrative_state", new java.lang.Integer (14));
    _methods.put ("get_forwarding_state", new java.lang.Integer (15));
    _methods.put ("set_forwarding_state", new java.lang.Integer (16));
    _methods.put ("get_operational_state", new java.lang.Integer (17));
    _methods.put ("get_interval", new java.lang.Integer (18));
    _methods.put ("set_interval", new java.lang.Integer (19));
    _methods.put ("get_availability_status", new java.lang.Integer (20));
    _methods.put ("get_capacity_alarm_thresholds", new java.lang.Integer (21));
    _methods.put ("set_capacity_alarm_thresholds", new java.lang.Integer (22));
    _methods.put ("get_week_mask", new java.lang.Integer (23));
    _methods.put ("set_week_mask", new java.lang.Integer (24));
    _methods.put ("query", new java.lang.Integer (25));
    _methods.put ("retrieve", new java.lang.Integer (26));
    _methods.put ("match", new java.lang.Integer (27));
    _methods.put ("delete_records", new java.lang.Integer (28));
    _methods.put ("delete_records_by_id", new java.lang.Integer (29));
    _methods.put ("write_records", new java.lang.Integer (30));
    _methods.put ("set_record_attribute", new java.lang.Integer (31));
    _methods.put ("set_records_attribute", new java.lang.Integer (32));
    _methods.put ("get_record_attribute", new java.lang.Integer (33));
    _methods.put ("copy", new java.lang.Integer (34));
    _methods.put ("copy_with_id", new java.lang.Integer (35));
    _methods.put ("flush", new java.lang.Integer (36));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // DsLogAdmin/BasicLog/destroy
       {
         this.destroy ();
         out = $rh.createReply();
         break;
       ...
       case 1:  // DsLogAdmin/Log/my_factory
       {
       ...
       case 3:  // DsLogAdmin/Log/get_log_qos
       {
         short $result[] = null;
       ...
       case 4:  // DsLogAdmin/Log/set_log_qos
       {
         try {
  ...
  // life in seconds (0 infinite)
       case 5:  // DsLogAdmin/Log/get_max_record_life
       {
         int $result = (int)0;
       ...
       case 6:  // DsLogAdmin/Log/set_max_record_life
       {
  ...
  // size in octets
       case 7:  // DsLogAdmin/Log/get_max_size
       {
         long $result = (long)0;
       ...
       case 8:  // DsLogAdmin/Log/set_max_size
       {
         try {
       ...
       case 9:  // DsLogAdmin/Log/get_current_size
       {
         long $result = (long)0;
  ...
  // size in octets
       case 10:  // DsLogAdmin/Log/get_n_records
       {
         long $result = (long)0;
  ...
  // number of records
       case 11:  // DsLogAdmin/Log/get_log_full_action
       {
       ...
       case 12:  // DsLogAdmin/Log/set_log_full_action
       {
         try {
       ...
       case 13:  // DsLogAdmin/Log/get_administrative_state
       {
       ...
       case 14:  // DsLogAdmin/Log/set_administrative_state
       {
       ...
       case 15:  // DsLogAdmin/Log/get_forwarding_state
       {
       ...
       case 16:  // DsLogAdmin/Log/set_forwarding_state
       {
       ...
       case 17:  // DsLogAdmin/Log/get_operational_state
       {
  ...
  // log duration
       case 18:  // DsLogAdmin/Log/get_interval
       {
       ...
       case 19:  // DsLogAdmin/Log/set_interval
       {
         try {
  ...
  // availability status
       case 20:  // DsLogAdmin/Log/get_availability_status
       {
  ...
  // capacity alarm threshold
       case 21:  // DsLogAdmin/Log/get_capacity_alarm_thresholds
       {
         short $result[] = null;
       ...
       case 22:  // DsLogAdmin/Log/set_capacity_alarm_thresholds
       {
         try {
  ...
  // weekly scheduling
       case 23:  // DsLogAdmin/Log/get_week_mask
       {
       ...
       case 24:  // DsLogAdmin/Log/set_week_mask
       {
         try {
  ...
  // negative how_many indicates backwards retrieval
       case 26:  // DsLogAdmin/Log/retrieve
       {
  ...
  // returns number of records deleted
       case 28:  // DsLogAdmin/Log/delete_records
       {
         try {
           String grammar = in.read_string ();
           String c = DsLogAdmin.ConstraintHelper.read (in);
       ...
       case 29:  // DsLogAdmin/Log/delete_records_by_id
       {
       ...
       case 30:  // DsLogAdmin/Log/write_records
       {
         try {
  ...
  // set single record attributes
       case 31:  // DsLogAdmin/Log/set_record_attribute
       {
         try {
  ...
  // returns number of records whose attributes have been set
       case 32:  // DsLogAdmin/Log/set_records_attribute
       {
         try {
           String grammar = in.read_string ();
           String c = DsLogAdmin.ConstraintHelper.read (in);
  ...
  // get record attributes
       case 33:  // DsLogAdmin/Log/get_record_attribute
       {
         try {
           long id = DsLogAdmin.RecordIdHelper.read (in);
       ...
       case 35:  // DsLogAdmin/Log/copy_with_id
       {
         try {
  ...
  public BasicLog _this() 
  {
    return BasicLogHelper.narrow(
    super._this_object());
  }

  public BasicLog _this(org.omg.CORBA.ORB orb) 
  {
    return BasicLogHelper.narrow(
