...
/**
* maintenanceOps/_MaintenanceMgr_IStub.java .
...
/**
   ...
   **/
public class _MaintenanceMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements maintenanceOps.MaintenanceMgr_I
{
  ...
  public void performMaintenanceOperation (maintenanceOps.CurrentMaintenanceOperation_T maintenanceOperation, maintenanceOps.MaintenanceOperationMode_T maintenanceOperationMode) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("performMaintenanceOperation", true);
                maintenanceOps.CurrentMaintenanceOperation_THelper.write ($out, maintenanceOperation);
                maintenanceOps.MaintenanceOperationMode_THelper.write ($out, maintenanceOperationMode);
                $in = _invoke ($out);
                return;
                ...
                performMaintenanceOperation (maintenanceOperation, maintenanceOperationMode        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getActiveMaintenanceOperations (globaldefs.NameAndStringValue_T[] tpOrMeName, int how_many, maintenanceOps.CurrentMaintenanceOperationList_THolder currentMaintenanceOperationList, maintenanceOps.CurrentMaintenanceOperationIterator_IHolder cmoIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getActiveMaintenanceOperations", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpOrMeName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                currentMaintenanceOperationList.value = maintenanceOps.CurrentMaintenanceOperationList_THelper.read ($in);
                cmoIt.value = maintenanceOps.CurrentMaintenanceOperationIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getActiveMaintenanceOperations (tpOrMeName, how_many, currentMaintenanceOperationList, cmoIt        );
            } finally {
                _releaseReply ($in);
            }
