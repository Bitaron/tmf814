...
/**
* flowDomainFragment/_MFDFrIterator_IStub.java .
...
/**
   ...
   **/
public class _MFDFrIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements flowDomainFragment.MFDFrIterator_I
{
  ...
  public boolean next_n (int how_many, flowDomainFragment.MatrixFlowDomainFragmentList_THolder mfdfrList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                mfdfrList.value = flowDomainFragment.MatrixFlowDomainFragmentList_THelper.read ($in);
                return $result;
                ...
                return next_n (how_many, mfdfrList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
