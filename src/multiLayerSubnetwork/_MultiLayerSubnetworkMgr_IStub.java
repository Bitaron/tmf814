...
/**
* multiLayerSubnetwork/_MultiLayerSubnetworkMgr_IStub.java .
...
/**
   ...
   **/
public class _MultiLayerSubnetworkMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements multiLayerSubnetwork.MultiLayerSubnetworkMgr_I
{
  ...
  public void getAllManagedElements (globaldefs.NameAndStringValue_T[] subnetName, int how_many, managedElement.ManagedElementList_THolder meList, managedElement.ManagedElementIterator_IHolder meIt) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                ...
                getAllManagedElements (subnetName, how_many, meList, meIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllManagedElementNames (globaldefs.NameAndStringValue_T[] subnetName, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                getAllManagedElementNames (subnetName, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getMultiLayerSubnetwork (globaldefs.NameAndStringValue_T[] subnetName, multiLayerSubnetwork.MultiLayerSubnetwork_THolder subnetwork) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMultiLayerSubnetwork", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $in = _invoke ($out);
                subnetwork.value = multiLayerSubnetwork.MultiLayerSubnetwork_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getMultiLayerSubnetwork (subnetName, subnetwork        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllTopologicalLinks (globaldefs.NameAndStringValue_T[] subnetName, int how_many, topologicalLink.TopologicalLinkList_THolder topoList, topologicalLink.TopologicalLinkIterator_IHolder topoIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTopologicalLinks", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllTopologicalLinks (subnetName, how_many, topoList, topoIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllTopologicalLinkNames (globaldefs.NameAndStringValue_T[] subnetName, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTopologicalLinkNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                nameList.value = globaldefs.NamingAttributesList_THelper.read ($in);
                ...
                getAllTopologicalLinkNames (subnetName, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getTopologicalLink (globaldefs.NameAndStringValue_T[] topoLinkName, topologicalLink.TopologicalLink_THolder topoLink) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTopologicalLink", true);
                ...
                getTopologicalLink (topoLinkName, topoLink        );
            } finally {
                _releaseReply ($in);
            }
  } // getTopologicalLink
  ...
  public void getAllEdgePoints (globaldefs.NameAndStringValue_T[] subnetName, short[] tpLayerRateList, short[] connectionLayerRateList, int how_many, terminationPoint.TerminationPointList_THolder tpList, terminationPoint.TerminationPointIterator_IHolder tpIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllEdgePoints", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                ...
                getAllEdgePoints (subnetName, tpLayerRateList, connectionLayerRateList, how_many, tpList, tpIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllEdgePoints
  ...
  public void getAllEdgePointNames (globaldefs.NameAndStringValue_T[] subnetName, short[] layerRateList, short[] connectionLayerRateList, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllEdgePointNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                ...
                getAllEdgePointNames (subnetName, layerRateList, connectionLayerRateList, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAssociatedTP (globaldefs.NameAndStringValue_T[] tpName, terminationPoint.TerminationPointList_THolder tpList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAssociatedTP", true);
  ...
  public void getTPGroupingRelationships (globaldefs.NameAndStringValue_T[] tpName, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTPGroupingRelationships", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                nameList.value = globaldefs.NamingAttributesList_THelper.read ($in);
                ...
                getTPGroupingRelationships (tpName, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllSubnetworkConnections (globaldefs.NameAndStringValue_T[] subnetName, short[] connectionRateList, int how_many, subnetworkConnection.SubnetworkConnectionList_THolder sncList, subnetworkConnection.SNCIterator_IHolder sncIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubnetworkConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                sncList.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                sncIt.value = subnetworkConnection.SNCIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllSubnetworkConnections (subnetName, connectionRateList, how_many, sncList, sncIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllSubnetworkConnectionNames (globaldefs.NameAndStringValue_T[] subnetName, short[] connectionRateList, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubnetworkConnectionNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllSubnetworkConnectionNames (subnetName, connectionRateList, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllSubnetworkConnectionsWithTP (globaldefs.NameAndStringValue_T[] tpName, short[] connectionRateList, int how_many, subnetworkConnection.SubnetworkConnectionList_THolder sncList, subnetworkConnection.SNCIterator_IHolder sncIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubnetworkConnectionsWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllSubnetworkConnectionsWithTP (tpName, connectionRateList, how_many, sncList, sncIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllSubnetworkConnectionNamesWithTP (globaldefs.NameAndStringValue_T[] tpName, short[] connectionRateList, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubnetworkConnectionNamesWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllSubnetworkConnectionNamesWithTP (tpName, connectionRateList, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getRoute (globaldefs.NameAndStringValue_T[] sncName, boolean includeHigherOrderCCs, subnetworkConnection.Route_THolder route) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_boolean (includeHigherOrderCCs);
                $in = _invoke ($out);
                route.value = subnetworkConnection.Route_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getRoute (sncName, includeHigherOrderCCs, route        );
            } finally {
                _releaseReply ($in);
            }
  } // getRoute
  ...
  public void getRouteAndTopologicalLinks (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.Route_THolder route, topologicalLink.TopologicalLinkList_THolder topologicalLinkList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRouteAndTopologicalLinks", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $in = _invoke ($out);
                route.value = subnetworkConnection.Route_THelper.read ($in);
                topologicalLinkList.value = topologicalLink.TopologicalLinkList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getRouteAndTopologicalLinks (sncName, route, topologicalLinkList        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getSNC (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.SubnetworkConnection_THolder snc) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $in = _invoke ($out);
                snc.value = subnetworkConnection.SubnetworkConnection_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /**
     ...
     * <br>
     **/
  public void getSNCsByUserLabel (String userLabel, subnetworkConnection.SubnetworkConnectionList_THolder sncList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getSNCsByUserLabel", true);
                ...
                getSNCsByUserLabel (userLabel, sncList        );
            } finally {
                _releaseReply ($in);
            }
  } // getSNCsByUserLabel
  ...
  public void createSNC (subnetworkConnection.SNCCreateData_T createData, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.SubnetworkConnection_THolder theSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createSNC", true);
                subnetworkConnection.SNCCreateData_THelper.write ($out, createData);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                $in = _invoke ($out);
                theSNC.value = subnetworkConnection.SubnetworkConnection_THelper.read ($in);
                ...
                createSNC (createData, tolerableImpact, emsFreedomLevel, theSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // createSNC
  ...
  public void activateSNC (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder theSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("activateSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                ...
                activateSNC (sncName, tolerableImpact, emsFreedomLevel, tpsToModify, theSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // activateSNC
  ...
  public void createAndActivateSNC (subnetworkConnection.SNCCreateData_T createData, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder theSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createAndActivateSNC", true);
                subnetworkConnection.SNCCreateData_THelper.write ($out, createData);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                ...
                createAndActivateSNC (createData, tolerableImpact, emsFreedomLevel, tpsToModify, theSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void deactivateSNC (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder theSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deactivateSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                ...
                deactivateSNC (sncName, tolerableImpact, emsFreedomLevel, tpsToModify, theSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // deactivateSNC
  ...
  public void deleteSNC (globaldefs.NameAndStringValue_T[] sncName, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                $in = _invoke ($out);
                return;
                ...
                deleteSNC (sncName, emsFreedomLevel        );
            } finally {
                _releaseReply ($in);
            }
  } // deleteSNC
  ...
  public void deactivateAndDeleteSNC (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder theSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deactivateAndDeleteSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                ...
                deactivateAndDeleteSNC (sncName, tolerableImpact, emsFreedomLevel, tpsToModify, theSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void checkValidSNC (subnetworkConnection.SNCCreateData_T createData, subnetworkConnection.TPData_T[] tpsToModify, boolean considerResources, org.omg.CORBA.BooleanHolder valid) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("checkValidSNC", true);
                subnetworkConnection.SNCCreateData_THelper.write ($out, createData);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify);
                $out.write_boolean (considerResources);
                $in = _invoke ($out);
                valid.value = $in.read_boolean ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                checkValidSNC (createData, tpsToModify, considerResources, valid        );
            } finally {
                _releaseReply ($in);
            }
  } // checkValidSNC
  ...
  public void getAllTPPools (globaldefs.NameAndStringValue_T[] subnetworkName, int how_many, terminationPoint.TerminationPointList_THolder tpList, terminationPoint.TerminationPointIterator_IHolder tpIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTPPools", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetworkName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                tpList.value = terminationPoint.TerminationPointList_THelper.read ($in);
                tpIt.value = terminationPoint.TerminationPointIterator_IHelper.read ($in);
                ...
                getAllTPPools (subnetworkName, how_many, tpList, tpIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllTPPools
  ...
  public void getAllTPPoolNames (globaldefs.NameAndStringValue_T[] subnetworkName, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTPPoolNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetworkName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                nameList.value = globaldefs.NamingAttributesList_THelper.read ($in);
                ...
                getAllTPPoolNames (subnetworkName, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllTPPoolNames
  ...
  public void getAllFixedSubnetworkConnections (globaldefs.NameAndStringValue_T[] subnetName, short[] connectionRateList, int how_many, subnetworkConnection.SubnetworkConnectionList_THolder sncList, subnetworkConnection.SNCIterator_IHolder sncIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllFixedSubnetworkConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllFixedSubnetworkConnections (subnetName, connectionRateList, how_many, sncList, sncIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllFixedSubnetworkConnectionNames (globaldefs.NameAndStringValue_T[] subnetName, short[] connectionRateList, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllFixedSubnetworkConnectionNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllFixedSubnetworkConnectionNames (subnetName, connectionRateList, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllFixedSubnetworkConnectionsWithTP (globaldefs.NameAndStringValue_T[] tpName, short[] connectionRateList, int how_many, subnetworkConnection.SubnetworkConnectionList_THolder sncList, subnetworkConnection.SNCIterator_IHolder sncIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllFixedSubnetworkConnectionsWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllFixedSubnetworkConnectionsWithTP (tpName, connectionRateList, how_many, sncList, sncIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllFixedSubnetworkConnectionNamesWithTP (globaldefs.NameAndStringValue_T[] tpName, short[] connectionRateList, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllFixedSubnetworkConnectionNamesWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                transmissionParameters.LayerRateList_THelper.write ($out, connectionRateList);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllFixedSubnetworkConnectionNamesWithTP (tpName, connectionRateList, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void createModifiedSNC (globaldefs.NameAndStringValue_T[] sncName, String routeId, subnetworkConnection.SNCModifyData_T SNCModifyData, subnetworkConnection.GradesOfImpact_T tolerableImpact, subnetworkConnection.ProtectionEffort_T tolerableImpactEffort, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder newSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createModifiedSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                subnetworkConnection.SNCModifyData_THelper.write ($out, SNCModifyData);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                subnetworkConnection.ProtectionEffort_THelper.write ($out, tolerableImpactEffort);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                newSNC.value = subnetworkConnection.SubnetworkConnection_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                createModifiedSNC (sncName, routeId, SNCModifyData, tolerableImpact, tolerableImpactEffort, emsFreedomLevel, tpsToModify, newSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // createModifiedSNC
  ...
  public void swapSNC (globaldefs.NameAndStringValue_T[] nameOfSNCtoBeDeactivated, globaldefs.NameAndStringValue_T[] nameOfSNCtoBeActivated, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.GradesOfImpact_T tolerableImpact, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SNCState_THolder stateOfActivatedSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("swapSNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, nameOfSNCtoBeDeactivated);
                globaldefs.NamingAttributes_THelper.write ($out, nameOfSNCtoBeActivated);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                stateOfActivatedSNC.value = subnetworkConnection.SNCState_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                swapSNC (nameOfSNCtoBeDeactivated, nameOfSNCtoBeActivated, emsFreedomLevel, tolerableImpact, tpsToModify, stateOfActivatedSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // swapSNC
  ...
  public void modifySNC (globaldefs.NameAndStringValue_T[] sncName, String routeId, subnetworkConnection.SNCModifyData_T SNCModifyData, subnetworkConnection.GradesOfImpact_T tolerableImpact, subnetworkConnection.ProtectionEffort_T tolerableImpactEffort, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnection_THolder newSNC, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("modifySNC", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                subnetworkConnection.SNCModifyData_THelper.write ($out, SNCModifyData);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                ...
                modifySNC (sncName, routeId, SNCModifyData, tolerableImpact, tolerableImpactEffort, emsFreedomLevel, tpsToModify, newSNC, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // modifySNC
  ...
  /** 
     ...
     * <br>
     **/
  public void getBackupRoutes (globaldefs.NameAndStringValue_T[] sncName, String routeId, boolean includeHigherOrderCCs, globaldefs.NVSList_THolder additionalInfo, subnetworkConnection.RouteList_THolder routeList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getBackupRoutes", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                $out.write_boolean (includeHigherOrderCCs);
                ...
                routeList.value = subnetworkConnection.RouteList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getBackupRoutes (sncName, routeId, includeHigherOrderCCs, additionalInfo, routeList        );
            } finally {
                _releaseReply ($in);
            }
  } // getBackupRoutes
  ...
  public void switchRoute (globaldefs.NameAndStringValue_T[] sncName, String routeId, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.TPDataList_THolder tpsToModify, globaldefs.NVSList_THolder additionalInfo, subnetworkConnection.SNCState_THolder sncState, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("switchRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                ...
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                additionalInfo.value = globaldefs.NVSList_THelper.read ($in);
                sncState.value = subnetworkConnection.SNCState_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                switchRoute (sncName, routeId, tolerableImpact, emsFreedomLevel, tpsToModify, additionalInfo, sncState, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // switchRoute
  ...
  public void addRoute (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.RouteCreateData_T createRoute, subnetworkConnection.GradesOfImpact_T tolerableImpact, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, subnetworkConnection.RouteDescriptor_THolder theRoute, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                subnetworkConnection.RouteCreateData_THelper.write ($out, createRoute);
                subnetworkConnection.GradesOfImpact_THelper.write ($out, tolerableImpact);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                $in = _invoke ($out);
                theRoute.value = subnetworkConnection.RouteDescriptor_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                addRoute (sncName, createRoute, tolerableImpact, emsFreedomLevel, theRoute, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // addRoute
  ...
  /**
     ...
     * <br>
     **/
  public void removeRoute (globaldefs.NameAndStringValue_T[] sncName, String routeId, multiLayerSubnetwork.EMSFreedomLevel_T emsFreedomLevel, globaldefs.NVSList_THolder additionalInfo) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("removeRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                multiLayerSubnetwork.EMSFreedomLevel_THelper.write ($out, emsFreedomLevel);
                globaldefs.NVSList_THelper.write ($out, additionalInfo.value);
                ...
                removeRoute (sncName, routeId, emsFreedomLevel, additionalInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // removeRoute
  ...
  /**
     ...
     * <br>
     **/
  public void setIntendedRoute (globaldefs.NameAndStringValue_T[] sncName, String routeId, globaldefs.NVSList_THolder additionalInfo) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setIntendedRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_string (routeId);
                globaldefs.NVSList_THelper.write ($out, additionalInfo.value);
                $in = _invoke ($out);
                ...
                setIntendedRoute (sncName, routeId, additionalInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // setIntendedRoute
  ...
  public void setRoutesAdminState (globaldefs.NameAndStringValue_T[] sncName, subnetworkConnection.RouteNameAndAdminStateList_THolder routeNameAndAdminStateList, subnetworkConnection.SNCState_THolder sncState) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setRoutesAdminState", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                ...
                setRoutesAdminState (sncName, routeNameAndAdminStateList, sncState        );
            } finally {
                _releaseReply ($in);
            }
  } // setRoutesAdminState
  ...
  public void getIntendedRoute (globaldefs.NameAndStringValue_T[] sncName, boolean includeHigherOrderCCs, globaldefs.NVSList_THolder additionalInfo, subnetworkConnection.Route_THolder route) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getIntendedRoute", true);
                globaldefs.NamingAttributes_THelper.write ($out, sncName);
                $out.write_boolean (includeHigherOrderCCs);
                globaldefs.NVSList_THelper.write ($out, additionalInfo.value);
                $in = _invoke ($out);
                ...
                getIntendedRoute (sncName, includeHigherOrderCCs, additionalInfo, route        );
            } finally {
                _releaseReply ($in);
            }
  } // getIntendedRoute
  ...
  public void createTPPool (multiLayerSubnetwork.TPPoolCreateData_T newTPPoolCreateData, terminationPoint.TerminationPoint_THolder newTPPool) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createTPPool", true);
                multiLayerSubnetwork.TPPoolCreateData_THelper.write ($out, newTPPoolCreateData);
                $in = _invoke ($out);
                newTPPool.value = terminationPoint.TerminationPoint_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                createTPPool (newTPPoolCreateData, newTPPool        );
            } finally {
                _releaseReply ($in);
            }
  } // createTPPool
  ...
  public void deleteTPPool (globaldefs.NameAndStringValue_T[] tpPoolName) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteTPPool", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpPoolName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  /**
     ...
     * <br>
     **/
  public void modifyTPPool (globaldefs.NameAndStringValue_T[] tPPoolName, globaldefs.NameAndStringValue_T[][] containedMembers, String actionType, terminationPoint.TerminationPoint_THolder modifiedTPPool) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("modifyTPPool", true);
                globaldefs.NamingAttributes_THelper.write ($out, tPPoolName);
                globaldefs.NamingAttributesList_THelper.write ($out, containedMembers);
                $out.write_string (actionType);
                $in = _invoke ($out);
                modifiedTPPool.value = terminationPoint.TerminationPoint_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                modifyTPPool (tPPoolName, containedMembers, actionType, modifiedTPPool        );
            } finally {
                _releaseReply ($in);
            }
  } // modifyTPPool
  ...
  public void getTPPool (globaldefs.NameAndStringValue_T[] tPPoolName, terminationPoint.TerminationPoint_THolder tPPool, org.omg.CORBA.IntHolder numberOfMembers, org.omg.CORBA.IntHolder numberOfIdleMembers, org.omg.CORBA.StringHolder descriptionOfUse) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTPPool", true);
                globaldefs.NamingAttributes_THelper.write ($out, tPPoolName);
                $in = _invoke ($out);
                tPPool.value = terminationPoint.TerminationPoint_THelper.read ($in);
                numberOfMembers.value = $in.read_ulong ();
                numberOfIdleMembers.value = $in.read_ulong ();
                descriptionOfUse.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getTPPool (tPPoolName, tPPool, numberOfMembers, numberOfIdleMembers, descriptionOfUse        );
            } finally {
                _releaseReply ($in);
            }
  } // getTPPool
  ...
  public void getAllSubordinateMLSNs (globaldefs.NameAndStringValue_T[] subnetName, int how_many, multiLayerSubnetwork.SubnetworkList_THolder subordinateMLSNsList, multiLayerSubnetwork.SubnetworkIterator_IHolder subnetIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubordinateMLSNs", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                subordinateMLSNsList.value = multiLayerSubnetwork.SubnetworkList_THelper.read ($in);
                subnetIt.value = multiLayerSubnetwork.SubnetworkIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllSubordinateMLSNs (subnetName, how_many, subordinateMLSNsList, subnetIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  /** 
     ...
     **/
  public void getAllSubordinateRAidsWithConnection (globaldefs.NameAndStringValue_T[] subnetName, globaldefs.NameAndStringValue_T[] connection, String routeType, multiLayerSubnetwork.RoutePerRouteType_THolder routePerRouteType) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllSubordinateRAidsWithConnection", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                globaldefs.NamingAttributes_THelper.write ($out, connection);
                callSNC.RouteType_THelper.write ($out, routeType);
                $in = _invoke ($out);
                routePerRouteType.value = multiLayerSubnetwork.RoutePerRouteType_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllSubordinateRAidsWithConnection (subnetName, connection, routeType, routePerRouteType        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getMLSNPPLink (globaldefs.NameAndStringValue_T[] mLSNPPLinkName, boolean sNPListRequested, mLSNPPLink.MultiLayerSNPPLink_THolder theMLSNPPLink) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMLSNPPLink", true);
                globaldefs.NamingAttributes_THelper.write ($out, mLSNPPLinkName);
                $out.write_boolean (sNPListRequested);
                $in = _invoke ($out);
                theMLSNPPLink.value = mLSNPPLink.MultiLayerSNPPLink_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getMLSNPPLink (mLSNPPLinkName, sNPListRequested, theMLSNPPLink        );
            } finally {
                _releaseReply ($in);
            }
  } // getMLSNPPLink
  ...
  public void getAllMLSNPPLinks (globaldefs.NameAndStringValue_T[] subnetName, boolean sNPListRequested, int how_many, mLSNPPLink.MLSNPPLinkList_THolder mLSNPPLinkList, mLSNPPLink.MLSNPPLinkIterator_IHolder mLSNPPLinkIt) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                getAllMLSNPPLinks (subnetName, sNPListRequested, how_many, mLSNPPLinkList, mLSNPPLinkIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllMLSNPPLinks
  ...
  public void getAllInternalMLSNPPLinks (globaldefs.NameAndStringValue_T[] subnetName, boolean sNPListRequested, int how_many, mLSNPPLink.MLSNPPLinkList_THolder mLSNPPLinkList, mLSNPPLink.MLSNPPLinkIterator_IHolder mLSNPPLinkIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllInternalMLSNPPLinks", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_boolean (sNPListRequested);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllInternalMLSNPPLinks (subnetName, sNPListRequested, how_many, mLSNPPLinkList, mLSNPPLinkIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllEdgeMLSNPPLinks (globaldefs.NameAndStringValue_T[] subnetName, boolean sNPListRequested, int how_many, mLSNPPLink.MLSNPPLinkList_THolder mLSNPPLinkList, mLSNPPLink.MLSNPPLinkIterator_IHolder mLSNPPLinkIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllEdgeMLSNPPLinks", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_boolean (sNPListRequested);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllEdgeMLSNPPLinks (subnetName, sNPListRequested, how_many, mLSNPPLinkList, mLSNPPLinkIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllMLSNPPs (globaldefs.NameAndStringValue_T[] subnetName, boolean sNPListRequested, int how_many, mLSNPP.MLSNPPList_THolder mLSNPPList, mLSNPP.MLSNPPIterator_IHolder mLSNPPIt) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                getAllMLSNPPs (subnetName, sNPListRequested, how_many, mLSNPPList, mLSNPPIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllMLSNPPs
  ...
  public void getAllCallsAndTopLevelConnections (globaldefs.NameAndStringValue_T[] subnetName, int how_many, callSNC.CallAndTopLevelConnectionsList_THolder callAndTopLevelConnectionsList, callSNC.CallAndTopLevelConnectionsIterator_IHolder callAndTopLevelConnectionsIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallsAndTopLevelConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                callAndTopLevelConnectionsList.value = callSNC.CallAndTopLevelConnectionsList_THelper.read ($in);
                callAndTopLevelConnectionsIt.value = callSNC.CallAndTopLevelConnectionsIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllCallsAndTopLevelConnections (subnetName, how_many, callAndTopLevelConnectionsList, callAndTopLevelConnectionsIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllCallsAndTopLevelConnectionsAndSNCs (globaldefs.NameAndStringValue_T[] subnetName, int how_many, callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder callAndTopLevelConnectionsAndSNCsList, callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IHolder callAndTopLevelConnectionsAndSNCsIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallsAndTopLevelConnectionsAndSNCs", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                callAndTopLevelConnectionsAndSNCsList.value = callSNC.CallAndTopLevelConnectionsAndSNCsList_THelper.read ($in);
                callAndTopLevelConnectionsAndSNCsIt.value = callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllCallsAndTopLevelConnectionsAndSNCs (subnetName, how_many, callAndTopLevelConnectionsAndSNCsList, callAndTopLevelConnectionsAndSNCsIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllCallsAndTopLevelConnectionsWithME (globaldefs.NameAndStringValue_T[] subnetName, globaldefs.NameAndStringValue_T[] meName, int how_many, callSNC.CallAndTopLevelConnectionsList_THolder callAndTopLevelConnectionsList, callSNC.CallAndTopLevelConnectionsIterator_IHolder callAndTopLevelConnectionsIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallsAndTopLevelConnectionsWithME", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                ...
                getAllCallsAndTopLevelConnectionsWithME (subnetName, meName, how_many, callAndTopLevelConnectionsList, callAndTopLevelConnectionsIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllCallsAndTopLevelConnectionsAndSNCsWithME (globaldefs.NameAndStringValue_T[] subnetName, globaldefs.NameAndStringValue_T[] meName, int how_many, callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder callAndTopLevelConnectionsAndSNCsList, callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IHolder callAndTopLevelConnectionsAndSNCsIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallsAndTopLevelConnectionsAndSNCsWithME", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                globaldefs.NamingAttributes_THelper.write ($out, meName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllCallsAndTopLevelConnectionsAndSNCsWithME (subnetName, meName, how_many, callAndTopLevelConnectionsAndSNCsList, callAndTopLevelConnectionsAndSNCsIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllCallsAndTopLevelConnectionsAndSNCsWithTP (globaldefs.NameAndStringValue_T[] subnetName, globaldefs.NameAndStringValue_T[] tPName, int how_many, callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder callAndTopLevelConnectionsAndSNCsList, callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IHolder callAndTopLevelConnectionsAndSNCsIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallsAndTopLevelConnectionsAndSNCsWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, subnetName);
                globaldefs.NamingAttributes_THelper.write ($out, tPName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllCallsAndTopLevelConnectionsAndSNCsWithTP (subnetName, tPName, how_many, callAndTopLevelConnectionsAndSNCsList, callAndTopLevelConnectionsAndSNCsIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllCallIdsWithTP (globaldefs.NameAndStringValue_T[] tPName, callSNC.CallIdList_THolder callIdList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallIdsWithTP", true);
                globaldefs.NamingAttributes_THelper.write ($out, tPName);
                $in = _invoke ($out);
                callIdList.value = callSNC.CallIdList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllCallIdsWithTP (tPName, callIdList        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllCallIdsWithTP
  ...
  public void getAllCallIdsWithSNPPOrTNAName (globaldefs.NameAndStringValue_T sNPPOrTNAName, callSNC.CallIdList_THolder callIdList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllCallIdsWithSNPPOrTNAName", true);
                globaldefs.NameAndStringValue_THelper.write ($out, sNPPOrTNAName);
                $in = _invoke ($out);
                callIdList.value = callSNC.CallIdList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                getAllCallIdsWithSNPPOrTNAName (sNPPOrTNAName, callIdList        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getCallAndTopLevelConnectionsAndSNCs (globaldefs.NameAndStringValue_T[] callName, callSNC.CallAndTopLevelConnectionsAndSNCs_THolder callAndTopLevelConnectionsAndSNCs) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getCallAndTopLevelConnectionsAndSNCs", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                $in = _invoke ($out);
                callAndTopLevelConnectionsAndSNCs.value = callSNC.CallAndTopLevelConnectionsAndSNCs_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getCallAndTopLevelConnectionsAndSNCs (callName, callAndTopLevelConnectionsAndSNCs        );
            } finally {
                _releaseReply ($in);
            }
  ...
  /**
     ...
     * and communications is required to complete the request.<br>
     **/
  public void getCallAndTopLevelConnections (globaldefs.NameAndStringValue_T[] callName, String callId, callSNC.CallAndTopLevelConnections_THolder callAndTopLevelConnections) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getCallAndTopLevelConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                $out.write_string (callId);
                $in = _invoke ($out);
                callAndTopLevelConnections.value = callSNC.CallAndTopLevelConnections_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getCallAndTopLevelConnections (callName, callId, callAndTopLevelConnections        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void establishCall (callSNC.CallCreateData_T callCreateData, subnetworkConnection.SNCCreateData_T[] connectionCreateDataList, String routeGroupsNumber, subnetworkConnection.TPDataList_THolder tpsToModify, callSNC.CallAndTopLevelConnectionsAndSNCs_THolder callAndTopLevelConnectionsAndSNCs, subnetworkConnection.SNCCreateDataList_THolder sNCsNotCreated, subnetworkConnection.SubnetworkConnectionList_THolder partialSNCs, org.omg.CORBA.StringHolder callErrorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("establishCall", true);
                callSNC.CallCreateData_THelper.write ($out, callCreateData);
                subnetworkConnection.SNCCreateDataList_THelper.write ($out, connectionCreateDataList);
                $out.write_string (routeGroupsNumber);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                callAndTopLevelConnectionsAndSNCs.value = callSNC.CallAndTopLevelConnectionsAndSNCs_THelper.read ($in);
                sNCsNotCreated.value = subnetworkConnection.SNCCreateDataList_THelper.read ($in);
                partialSNCs.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                callErrorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                establishCall (callCreateData, connectionCreateDataList, routeGroupsNumber, tpsToModify, callAndTopLevelConnectionsAndSNCs, sNCsNotCreated, partialSNCs, callErrorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // establishCall
  ...
  public void modifyCall (globaldefs.NameAndStringValue_T[] callName, callSNC.CallModifyData_T callModifyData, callSNC.Call_THolder modifiedCall) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("modifyCall", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                callSNC.CallModifyData_THelper.write ($out, callModifyData);
                $in = _invoke ($out);
                modifiedCall.value = callSNC.Call_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                modifyCall (callName, callModifyData, modifiedCall        );
            } finally {
                _releaseReply ($in);
            }
  } // modifyCall
  ...
  public void releaseCall (globaldefs.NameAndStringValue_T[] callName, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnectionList_THolder remainingSNCs, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("releaseCall", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                remainingSNCs.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                releaseCall (callName, tpsToModify, remainingSNCs, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // releaseCall
  ...
  public void getCall (globaldefs.NameAndStringValue_T[] callName, callSNC.Call_THolder theCall) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getCall", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                $in = _invoke ($out);
                theCall.value = callSNC.Call_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public void addConnections (globaldefs.NameAndStringValue_T[] callName, subnetworkConnection.SNCCreateData_T[] connectionsToAdd, boolean connectionRouteReArrangementAllowed, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnectionList_THolder connectionList, subnetworkConnection.SubnetworkConnectionList_THolder partialSNCs, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                subnetworkConnection.SNCCreateDataList_THelper.write ($out, connectionsToAdd);
                $out.write_boolean (connectionRouteReArrangementAllowed);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                connectionList.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                partialSNCs.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                addConnections (callName, connectionsToAdd, connectionRouteReArrangementAllowed, tpsToModify, connectionList, partialSNCs, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // addConnections
  ...
  public void removeConnections (globaldefs.NameAndStringValue_T[] callName, globaldefs.NameAndStringValue_T[][] connectionNamesList, subnetworkConnection.TPDataList_THolder tpsToModify, subnetworkConnection.SubnetworkConnectionList_THolder sNCsNotDeleted, org.omg.CORBA.StringHolder errorReason) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("removeConnections", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                globaldefs.NamingAttributesList_THelper.write ($out, connectionNamesList);
                subnetworkConnection.TPDataList_THelper.write ($out, tpsToModify.value);
                $in = _invoke ($out);
                tpsToModify.value = subnetworkConnection.TPDataList_THelper.read ($in);
                sNCsNotDeleted.value = subnetworkConnection.SubnetworkConnectionList_THelper.read ($in);
                errorReason.value = $in.read_string ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                removeConnections (callName, connectionNamesList, tpsToModify, sNCsNotDeleted, errorReason        );
            } finally {
                _releaseReply ($in);
            }
  } // removeConnections
  ...
  /**
     ...
     * <br>
     **/
  public void getConnectionsAndRouteDetails (String callID, globaldefs.NameAndStringValue_T[] mLRAName, String sNPOrSNPPID, boolean mLSNPPLinkRequested, String routeType, callSNC.SNCAndRouteList_THolder connectionAndRouteList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getConnectionsAndRouteDetails", true);
                $out.write_string (callID);
                globaldefs.NamingAttributes_THelper.write ($out, mLRAName);
                $out.write_string (sNPOrSNPPID);
                $out.write_boolean (mLSNPPLinkRequested);
                callSNC.RouteType_THelper.write ($out, routeType);
                $in = _invoke ($out);
                connectionAndRouteList.value = callSNC.SNCAndRouteList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getConnectionsAndRouteDetails (callID, mLRAName, sNPOrSNPPID, mLSNPPLinkRequested, routeType, connectionAndRouteList        );
            } finally {
                _releaseReply ($in);
            }
  ...
  *
  ...
  public void modifyDiversityAndCorouting (globaldefs.NameAndStringValue_T[] callName, callSNC.Diversity_T callDiversity, callSNC.RouteGroupInfo_T[] routeGroupInfoList, boolean connectionRouteReArrangementAllowed, String routeGroupsNumber, globaldefs.NVSList_THolder additionalInfo, callSNC.CallAndTopLevelConnections_THolder callAndTopLevelConnections) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("modifyDiversityAndCorouting", true);
                globaldefs.NamingAttributes_THelper.write ($out, callName);
                callSNC.Diversity_THelper.write ($out, callDiversity);
                callSNC.RouteGroupInfoList_THelper.write ($out, routeGroupInfoList);
                $out.write_boolean (connectionRouteReArrangementAllowed);
                $out.write_string (routeGroupsNumber);
                globaldefs.NVSList_THelper.write ($out, additionalInfo.value);
                $in = _invoke ($out);
                ...
                modifyDiversityAndCorouting (callName, callDiversity, routeGroupInfoList, connectionRouteReArrangementAllowed, routeGroupsNumber, additionalInfo, callAndTopLevelConnections        );
            } finally {
                _releaseReply ($in);
            }
...
} // class _MultiLayerSubnetworkMgr_IStub
