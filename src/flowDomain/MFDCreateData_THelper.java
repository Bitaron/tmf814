...
/**
* flowDomain/MFDCreateData_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from flowDomain.idl
* Wednesday, June 15, 2016 7:24:36 PM COT
*/

abstract public class MFDCreateData_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/flowDomain/MFDCreateData_T:1.0";

  public static void insert (org.omg.CORBA.Any a, flowDomain.MFDCreateData_T that)
  {
  ...
  public static flowDomain.MFDCreateData_T extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[7] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (flowDomain.MFDCreateData_THelper.id (), "MFDCreateData_T", _members0);
          __active = false;
        }
      }
    }
  ...
  public static flowDomain.MFDCreateData_T read (org.omg.CORBA.portable.InputStream istream)
  {
    flowDomain.MFDCreateData_T value = new flowDomain.MFDCreateData_T ();
    ...
    value.unassignedCPTPs = globaldefs.NamingAttributesList_THelper.read (istream);
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, flowDomain.MFDCreateData_T value)
  {
    ...
    globaldefs.NamingAttributesList_THelper.write (ostream, value.unassignedCPTPs);
