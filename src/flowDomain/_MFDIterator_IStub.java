...
/**
* flowDomain/_MFDIterator_IStub.java .
...
/**
   ...
   **/
public class _MFDIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements flowDomain.MFDIterator_I
{
  ...
  public boolean next_n (int how_many, flowDomain.MFDList_THolder mfdList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                mfdList.value = flowDomain.MFDList_THelper.read ($in);
                return $result;
                ...
                return next_n (how_many, mfdList        );
            } finally {
                _releaseReply ($in);
            }
  } // next_n
