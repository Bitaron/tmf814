...
/**
* flowDomain/_FDIterator_IStub.java .
...
/**
   ...
   **/
public class _FDIterator_IStub extends org.omg.CORBA.portable.ObjectImpl implements flowDomain.FDIterator_I
{
  ...
  public boolean next_n (int how_many, flowDomain.FDList_THolder fdList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                ...
                fdList.value = flowDomain.FDList_THelper.read ($in);
                return $result;
