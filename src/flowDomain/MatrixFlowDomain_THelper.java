...
/**
* flowDomain/MatrixFlowDomain_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from flowDomain.idl
* Wednesday, June 15, 2016 7:24:36 PM COT
*/

abstract public class MatrixFlowDomain_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/flowDomain/MatrixFlowDomain_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[7] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (flowDomain.MatrixFlowDomain_THelper.id (), "MatrixFlowDomain_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    flowDomain.MatrixFlowDomain_T value = new flowDomain.MatrixFlowDomain_T ();
