...
/**
* flowDomain/FlowDomain_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from flowDomain.idl
* Wednesday, June 15, 2016 7:24:36 PM COT
*/

abstract public class FlowDomain_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/flowDomain/FlowDomain_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          _tcOf_members0 = flowDomain.ConnectivityState_THelper.type ();
          _members0[6] = new org.omg.CORBA.StructMember (
            "fDConnectivityState",
            _tcOf_members0,
            null);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_string_tc (0);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (flowDomain.FDType_THelper.id (), "FDType_T", _tcOf_members0);
          ...
          _members0[8] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (flowDomain.FlowDomain_THelper.id (), "FlowDomain_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    flowDomain.FlowDomain_T value = new flowDomain.FlowDomain_T ();
    ...
    value.fDConnectivityState = flowDomain.ConnectivityState_THelper.read (istream);
    value.fdType = istream.read_string ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, flowDomain.FlowDomain_T value)
  {
    ...
    flowDomain.ConnectivityState_THelper.write (ostream, value.fDConnectivityState);
    ostream.write_string (value.fdType);
