...
/**
* flowDomain/FTPCreateData_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from flowDomain.idl
* Wednesday, June 15, 2016 7:24:36 PM COT
*/

abstract public class FTPCreateData_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/flowDomain/FTPCreateData_T:1.0";

  public static void insert (org.omg.CORBA.Any a, flowDomain.FTPCreateData_T that)
  {
  ...
  public static flowDomain.FTPCreateData_T extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[10] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (flowDomain.FTPCreateData_THelper.id (), "FTPCreateData_T", _members0);
          __active = false;
        }
      }
    }
  ...
  public static flowDomain.FTPCreateData_T read (org.omg.CORBA.portable.InputStream istream)
  {
    flowDomain.FTPCreateData_T value = new flowDomain.FTPCreateData_T ();
    value.equipmentName = globaldefs.NVSList_THelper.read (istream);
    ...
    value.ingressTransmissionDescriptorName = globaldefs.NVSList_THelper.read (istream);
    value.egressTransmissionDescriptorName = globaldefs.NVSList_THelper.read (istream);
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, flowDomain.FTPCreateData_T value)
  {
    globaldefs.NVSList_THelper.write (ostream, value.equipmentName);
    ...
    globaldefs.NVSList_THelper.write (ostream, value.ingressTransmissionDescriptorName);
    globaldefs.NVSList_THelper.write (ostream, value.egressTransmissionDescriptorName);
