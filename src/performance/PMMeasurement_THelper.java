...
/**
* performance/PMMeasurement_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from performance.idl
* Wednesday, June 15, 2016 7:24:40 PM COT
*/

abstract public class PMMeasurement_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/performance/PMMeasurement_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[4] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (performance.PMMeasurement_THelper.id (), "PMMeasurement_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    performance.PMMeasurement_T value = new performance.PMMeasurement_T ();
    ...
    value.intervalStatus = istream.read_string ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, performance.PMMeasurement_T value)
  {
    ...
    ostream.write_string (value.intervalStatus);
  }
