...
/**
* performance/_PerformanceManagementMgr_IStub.java .
...
/**
   ...
   **/
public class _PerformanceManagementMgr_IStub extends org.omg.CORBA.portable.ObjectImpl implements performance.PerformanceManagementMgr_I
{
  ...
  public void getMEPMcapabilities (globaldefs.NameAndStringValue_T[] meName, short layerRate, performance.PMParameterList_THolder pmParameterList) throws globaldefs.ProcessingFailureException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMEPMcapabilities", true);
                globaldefs.NamingAttributes_THelper.write ($out, meName);
                transmissionParameters.LayerRate_THelper.write ($out, layerRate);
                $in = _invoke ($out);
                pmParameterList.value = performance.PMParameterList_THelper.read ($in);
                return;
                ...
                getMEPMcapabilities (meName, layerRate, pmParameterList        );
            } finally {
                _releaseReply ($in);
            }
  } // getMEPMcapabilities
  ...
  public void disablePMData (performance.PMTPSelect_T[] pmTPSelectList, performance.PMTPSelectList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("disablePMData", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                $in = _invoke ($out);
                failedTPSelectList.value = performance.PMTPSelectList_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                disablePMData (pmTPSelectList, failedTPSelectList        );
            } finally {
                _releaseReply ($in);
            }
  } // disablePMData
  ...
  public void enablePMData (performance.PMTPSelect_T[] pmTPSelectList, performance.PMTPSelectList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("enablePMData", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                $in = _invoke ($out);
                failedTPSelectList.value = performance.PMTPSelectList_THelper.read ($in);
                return;
                ...
                enablePMData (pmTPSelectList, failedTPSelectList        );
            } finally {
                _releaseReply ($in);
            }
  } // enablePMData
  ...
  public void clearPMData (performance.PMTPSelect_T[] pmTPSelectList, performance.PMTPSelectList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("clearPMData", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                $in = _invoke ($out);
                failedTPSelectList.value = performance.PMTPSelectList_THelper.read ($in);
                return;
                ...
                clearPMData (pmTPSelectList, failedTPSelectList        );
            } finally {
                _releaseReply ($in);
            }
  } // clearPMData
  ...
  public void getHoldingTime (performance.HoldingTime_THolder holdingTime) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getHoldingTime", true);
                $in = _invoke ($out);
                holdingTime.value = performance.HoldingTime_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** 
     ...
     * <br>
     **/
  public void getTCATPParameter (globaldefs.NameAndStringValue_T[] tpName, short layerRate, String granularity, performance.TCAParameters_THolder tcaParameter) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTCATPParameter", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                transmissionParameters.LayerRate_THelper.write ($out, layerRate);
                performance.Granularity_THelper.write ($out, granularity);
                $in = _invoke ($out);
                tcaParameter.value = performance.TCAParameters_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getTCATPParameter (tpName, layerRate, granularity, tcaParameter        );
            } finally {
                _releaseReply ($in);
            }
  } // getTCATPParameter
  ...
  /**
     ...
     *  it may raise this exception. <br>
     **/
  public void getHistoryPMData (String destination, String userName, String password, performance.PMTPSelect_T[] pmTPSelectList, String[] pmParameters, String startTime, String endTime, boolean forceUpload) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getHistoryPMData", true);
                performance.Destination_THelper.write ($out, destination);
                $out.write_string (userName);
                $out.write_string (password);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                performance.PMParameterNameList_THelper.write ($out, pmParameters);
                globaldefs.Time_THelper.write ($out, startTime);
                globaldefs.Time_THelper.write ($out, endTime);
                $out.write_boolean (forceUpload);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                getHistoryPMData (destination, userName, password, pmTPSelectList, pmParameters, startTime, endTime, forceUpload        );
            } finally {
                _releaseReply ($in);
            }
  } // getHistoryPMData
  ...
  /**
     ...
     * <br>
     **/
  public void getAllCurrentPMData (performance.PMTPSelect_T[] pmTPSelectList, String[] pmParameters, int how_many, performance.PMDataList_THolder pmDataList, performance.PMDataIterator_IHolder pmIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                getAllCurrentPMData (pmTPSelectList, pmParameters, how_many, pmDataList, pmIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllCurrentPMData
  ...
  public void setTCATPParameter (globaldefs.NameAndStringValue_T[] tpName, performance.TCAParameters_THolder tcaParameters) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setTCATPParameter", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                ...
                setTCATPParameter (tpName, tcaParameters        );
            } finally {
                _releaseReply ($in);
            }
  } // setTCATPParameter
  ...
  public void enableTCA (performance.PMTPSelect_T[] pmTPSelectList, performance.PMTPSelectList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("enableTCA", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                $in = _invoke ($out);
                failedTPSelectList.value = performance.PMTPSelectList_THelper.read ($in);
                return;
                ...
                enableTCA (pmTPSelectList, failedTPSelectList        );
            } finally {
                _releaseReply ($in);
            }
  } // enableTCA
  ...
  public void disableTCA (performance.PMTPSelect_T[] pmTPSelectList, performance.PMTPSelectList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("disableTCA", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                $in = _invoke ($out);
                failedTPSelectList.value = performance.PMTPSelectList_THelper.read ($in);
                return;
                ...
                disableTCA (pmTPSelectList, failedTPSelectList        );
            } finally {
                _releaseReply ($in);
            }
  } // disableTCA
  ...
  public void getProfileAssociatedTPs (globaldefs.NameAndStringValue_T[] profileName, int how_many, globaldefs.NamingAttributesList_THolder tpNames, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getProfileAssociatedTPs", true);
                globaldefs.NamingAttributes_THelper.write ($out, profileName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                tpNames.value = globaldefs.NamingAttributesList_THelper.read ($in);
                ...
                getProfileAssociatedTPs (profileName, how_many, tpNames, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void createTCAParameterProfile (globaldefs.NameAndStringValue_T[] managedElementName, short layerRate, String userLabel, boolean forceUniqueness, String owner, globaldefs.NameAndStringValue_T[] additionalInfo, performance.TCAParameter_T[] listOfTCAParameter, performance.TCAParameterProfile_THolder tcaParameterProfile) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createTCAParameterProfile", true);
                ...
                performance.TCAParameterList_THelper.write ($out, listOfTCAParameter);
                $in = _invoke ($out);
                tcaParameterProfile.value = performance.TCAParameterProfile_THelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                createTCAParameterProfile (managedElementName, layerRate, userLabel, forceUniqueness, owner, additionalInfo, listOfTCAParameter, tcaParameterProfile        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void deleteTCAParameterProfile (globaldefs.NameAndStringValue_T[] tcaParameterProfileName) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("deleteTCAParameterProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcaParameterProfileName);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                deleteTCAParameterProfile (tcaParameterProfileName        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getTCAParameterProfile (globaldefs.NameAndStringValue_T[] tcaParameterProfileName, performance.TCAParameterProfile_THolder tcaParameterProfile) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTCAParameterProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcaParameterProfileName);
                $in = _invoke ($out);
                tcaParameterProfile.value = performance.TCAParameterProfile_THelper.read ($in);
                return;
                ...
                getTCAParameterProfile (tcaParameterProfileName, tcaParameterProfile        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void setTCAParameterProfile (globaldefs.NameAndStringValue_T[] tcaParameterProfileName, performance.TCAParameter_T[] listOfTCAParameter, int how_many, performance.TCAParameterProfile_THolder tcaParameterProfile, globaldefs.NamingAttributesList_THolder failedTPList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setTCAParameterProfile", true);
                globaldefs.NamingAttributes_THelper.write ($out, tcaParameterProfileName);
                performance.TCAParameterList_THelper.write ($out, listOfTCAParameter);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                setTCAParameterProfile (tcaParameterProfileName, listOfTCAParameter, how_many, tcaParameterProfile, failedTPList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllTCAParameterProfileNames (globaldefs.NameAndStringValue_T[] meName, int how_many, globaldefs.NamingAttributesList_THolder tcaParameterProfileNames, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTCAParameterProfileNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, meName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                tcaParameterProfileNames.value = globaldefs.NamingAttributesList_THelper.read ($in);
                nameIt.value = globaldefs.NamingAttributesIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                getAllTCAParameterProfileNames (meName, how_many, tcaParameterProfileNames, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  ...
  /**
     ...
     *  that the EMS can support has been reached<br>
     **/
  public void getTPHistoryPMData (performance.PMTPSelect_T[] pmTPSelectList, String[] pmParameters, String startTime, String endTime, int how_many, performance.PMDataList_THolder pmDataList, performance.PMDataIterator_IHolder pmIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTPHistoryPMData", true);
                performance.PMTPSelectList_THelper.write ($out, pmTPSelectList);
                performance.PMParameterNameList_THelper.write ($out, pmParameters);
                globaldefs.Time_THelper.write ($out, startTime);
                globaldefs.Time_THelper.write ($out, endTime);
                ...
                getTPHistoryPMData (pmTPSelectList, pmParameters, startTime, endTime, how_many, pmDataList, pmIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getTPHistoryPMData
  ...
  public void getAllPMPs (globaldefs.NameAndStringValue_T[] tpOrMeName, int how_many, performance.PMPList_THolder pmpList, performance.PMPIterator_IHolder pmpIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllPMPs", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpOrMeName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                pmpList.value = performance.PMPList_THelper.read ($in);
                pmpIt.value = performance.PMPIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllPMPs (tpOrMeName, how_many, pmpList, pmpIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllPMPs
  ...
  public void getAllPMPNames (globaldefs.NameAndStringValue_T[] tpOrMeName, int how_many, globaldefs.NamingAttributesList_THolder nameList, globaldefs.NamingAttributesIterator_IHolder nameIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllPMPNames", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpOrMeName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                ...
                getAllPMPNames (tpOrMeName, how_many, nameList, nameIt        );
            } finally {
                _releaseReply ($in);
            }
  } // getAllPMPNames
  ...
  public void setTCAParameterProfilePointer (globaldefs.NameAndStringValue_T[] tpName, globaldefs.NameAndStringValue_T[] addTCAParameterProfile, globaldefs.NameAndStringValue_T[] removeTCAParameterProfile) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setTCAParameterProfilePointer", true);
                globaldefs.NamingAttributes_THelper.write ($out, tpName);
                globaldefs.NamingAttributes_THelper.write ($out, addTCAParameterProfile);
                globaldefs.NamingAttributes_THelper.write ($out, removeTCAParameterProfile);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                setTCAParameterProfilePointer (tpName, addTCAParameterProfile, removeTCAParameterProfile        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public void getAllTCAParameterProfiles (globaldefs.NameAndStringValue_T[] meName, int how_many, performance.TCAParameterProfileList_THolder tcaParameterProfileList, performance.TCAParameterProfileIterator_IHolder tcaParameterProfileIt) throws globaldefs.ProcessingFailureException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAllTCAParameterProfiles", true);
                globaldefs.NamingAttributes_THelper.write ($out, meName);
                $out.write_ulong (how_many);
                $in = _invoke ($out);
                tcaParameterProfileList.value = performance.TCAParameterProfileList_THelper.read ($in);
                tcaParameterProfileIt.value = performance.TCAParameterProfileIterator_IHelper.read ($in);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                getAllTCAParameterProfiles (meName, how_many, tcaParameterProfileList, tcaParameterProfileIt        );
            } finally {
                _releaseReply ($in);
            }
...
} // class _PerformanceManagementMgr_IStub
