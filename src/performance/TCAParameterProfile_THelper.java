...
/**
* performance/TCAParameterProfile_THelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from performance.idl
* Wednesday, June 15, 2016 7:24:40 PM COT
*/

abstract public class TCAParameterProfile_THelper
{
  private static String  _id = "IDL:mtnm.tmforum.org/performance/TCAParameterProfile_T:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          _tcOf_members0 = performance.TCAParameter_THelper.type ();
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_sequence_tc (0, _tcOf_members0);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (performance.TCAParameterList_THelper.id (), "TCAParameterList_T", _tcOf_members0);
          _members0[6] = new org.omg.CORBA.StructMember (
            "tcaParameterList",
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (performance.TCAParameterProfile_THelper.id (), "TCAParameterProfile_T", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    performance.TCAParameterProfile_T value = new performance.TCAParameterProfile_T ();
    ...
    value.tcaParameterList = performance.TCAParameterList_THelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, performance.TCAParameterProfile_T value)
  {
    ...
    performance.TCAParameterList_THelper.write (ostream, value.tcaParameterList);
  }
